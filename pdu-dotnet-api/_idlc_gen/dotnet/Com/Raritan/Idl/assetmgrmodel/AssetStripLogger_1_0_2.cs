...
namespace Com.Raritan.Idl.assetmgrmodel {
  public class AssetStripLogger_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStripLogger:1.0.2", null);

    public AssetStripLogger_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public AssetStripLogger_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new AssetStripLogger_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new AssetStripLogger_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Record : ICloneable {
      ...
      public static Record Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.RecordType)(int)json["type"];
        ...
        inst.state = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_1.State)(int)json["state"];
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.RecordType type = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.RecordType.EMPTY;
      ...
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_1.State state = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_1.State.DISCONNECTED;
    }

    public class GetInfoResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.Info _ret_;
    }
    ...
    public GetInfoResult getInfo() {
      ...
      _ret._ret_ = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.Info.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.Record> records;
    }
    ...
    public GetRecordsResult getRecords(int id, int count) {
      ...
      _ret.records = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.Record>(_result["records"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_2.Record.Decode(_value, agent)));
      return _ret;
    }
