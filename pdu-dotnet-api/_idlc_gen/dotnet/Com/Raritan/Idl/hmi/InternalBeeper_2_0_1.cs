...
namespace Com.Raritan.Idl.hmi {
  public class InternalBeeper_2_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper:2.0.1", null);

    public InternalBeeper_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public InternalBeeper_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new InternalBeeper_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new InternalBeeper_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MuteChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper_2_0_1.MuteChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool muted = false;
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper_2_0_1.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.hmi.InternalBeeper_2_0_1.State state = Com.Raritan.Idl.hmi.InternalBeeper_2_0_1.State.OFF;
      public string reason = "";
      public bool mutedTemporarily = false;
    }
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.hmi.InternalBeeper_2_0_1.State _ret_;
      public string reason;
      public bool mutedTemporarily;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.hmi.InternalBeeper_2_0_1.State)(int)_result["_ret_"];
      _ret.reason = (string)_result["reason"];
      _ret.mutedTemporarily = (bool)_result["mutedTemporarily"];
      return _ret;
    }
    ...
    public class MuteCurrentActivationResult {
    }

    public MuteCurrentActivationResult muteCurrentActivation() {
      JsonObject _parameters = null;
      var _result = RpcCall("muteCurrentActivation", _parameters);
      var _ret = new MuteCurrentActivationResult();
      return _ret;
    }

    public AsyncRequest muteCurrentActivation(AsyncRpcResponse<MuteCurrentActivationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return muteCurrentActivation(rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest muteCurrentActivation(AsyncRpcResponse<MuteCurrentActivationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      JsonObject _parameters = null;
      return RpcCall("muteCurrentActivation", _parameters,
        _result => {
          try {
            var _ret = new MuteCurrentActivationResult();
            rsp(_ret);
