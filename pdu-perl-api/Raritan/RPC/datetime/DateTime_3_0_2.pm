...
package Raritan::RPC::datetime::DateTime_3_0_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "datetime.DateTime:3.0.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::datetime::DateTime_3_0_2::typeId;
...
sub getZoneInfos($$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'zoneInfos'}}; $i0++) {
        $$zoneInfos->[$i0] = Raritan::RPC::datetime::DateTime_3_0_2::ZoneInfo::decode($agent, $rsp->{'zoneInfos'}->[$i0]);
    }
}
...
sub getCfg($$) {
    ...
    $$cfg = Raritan::RPC::datetime::DateTime_3_0_2::Cfg::decode($agent, $rsp->{'cfg'});
}
...
sub setCfg($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'cfg'} = Raritan::RPC::datetime::DateTime_3_0_2::Cfg::encode($cfg);
...
sub getTime($$$$$$) {
    ...
    $$zone = Raritan::RPC::datetime::DateTime_3_0_2::ZoneInfo::decode($agent, $rsp->{'zone'});
    $$dstEnabled = ($rsp->{'dstEnabled'}) ? 1 : 0;
    $$utcOffset = $rsp->{'utcOffset'};
    $$currentTime = $rsp->{'currentTime'};
}

Raritan::RPC::Registry::registerProxyClass('datetime.DateTime', 3, 0, 2, 'Raritan::RPC::datetime::DateTime_3_0_2');
1;
