...
namespace Com.Raritan.Idl.lhxmodel {
  public class Sensor_4_0_3 : Com.Raritan.Idl.sensors.Sensor_4_0_3 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor:4.0.3", null);

    public Sensor_4_0_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Sensor_4_0_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Sensor_4_0_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Sensor_4_0_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class ThresholdsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_3.ThresholdsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds oldThresholds = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds();
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds newThresholds = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds();
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_3.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading oldReading = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading();
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading newReading = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading();
    }

    public class ReadingChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_3.ReadingChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetThresholdsResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds _ret_;
    }
    ...
    public GetThresholdsResult getThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds thresholds) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds thresholds, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresholds, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.NumThresholds thresholds, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresholds"] = thresholds.Encode();
      } catch (Exception e) {
    ...
    public class GetReadingResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading _ret_;
    }
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_3.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
