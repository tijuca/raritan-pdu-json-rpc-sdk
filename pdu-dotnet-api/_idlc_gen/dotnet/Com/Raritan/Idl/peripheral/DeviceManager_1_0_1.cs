...
namespace Com.Raritan.Idl.peripheral {
  public class DeviceManager_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager:1.0.1", null);

    public DeviceManager_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DeviceManager_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DeviceManager_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DeviceManager_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.ZCoordMode)(int)json["zCoordMode"];
      ...
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.ZCoordMode zCoordMode = Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.ZCoordMode.RACKUNITS;
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDeviceTypeInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.DeviceTypeInfo> _ret_;
    }
    ...
    public GetDeviceTypeInfosResult getDeviceTypeInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.DeviceTypeInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.DeviceManager_1_0_1.DeviceTypeInfo.Decode(_value, agent)));
      return _ret;
    }
