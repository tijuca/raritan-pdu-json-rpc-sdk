...
package Raritan::RPC::lhxmodel::Lhx_3_2_3::OpState;
...
sub encode {
    ...
    $encoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_2_3::AlertStatus::encode($in->{'alertStatus'});
...
sub decode {
    ...
    $decoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_2_3::AlertStatus::decode($agent, $in->{'alertStatus'});
