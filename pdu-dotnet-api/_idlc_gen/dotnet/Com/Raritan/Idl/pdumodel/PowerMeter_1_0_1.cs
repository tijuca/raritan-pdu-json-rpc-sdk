...
namespace Com.Raritan.Idl.pdumodel {
  public class PowerMeter_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter:1.0.1", null);

    public PowerMeter_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public PowerMeter_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new PowerMeter_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new PowerMeter_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Config : ICloneable {
      ...
      public static Config Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Type)(int)json["type"];
        return inst;
      }

      public int powerMeterId = 0;
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Type type = Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Type.ONE_PHASE;
    }

    public class GetConfigResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Config _ret_;
    }
    ...
    public GetConfigResult getConfig() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Config.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter_1_0_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings oldSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings();
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings newSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings();
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class EnergyPulseSettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter_1_0_1.EnergyPulseSettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings oldSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings();
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings newSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings();
    }

    public class GetEnergyPulseSettingsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings _ret_;
    }
    ...
    public GetEnergyPulseSettingsResult getEnergyPulseSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetEnergyPulseSettingsResult setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings settings) {
      var _parameters = new LightJson.JsonObject();
      _parameters["settings"] = settings.Encode();
    ...
    public AsyncRequest setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings settings, AsyncRpcResponse<SetEnergyPulseSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setEnergyPulseSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_0_1.EnergyPulseSettings settings, AsyncRpcResponse<SetEnergyPulseSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
