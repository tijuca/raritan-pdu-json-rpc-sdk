...
namespace Com.Raritan.Idl.pdumodel {
  public class TransferSwitch_3_1_1 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch:3.1.1", null);

    public TransferSwitch_3_1_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public TransferSwitch_3_1_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new TransferSwitch_3_1_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new TransferSwitch_3_1_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Type type = Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Type.STS;
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.selectedSource = Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["selectedSource"], agent));
        inst.operationalState = Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["operationalState"], agent));
        inst.sourceVoltagePhaseSyncAngle = Com.Raritan.Idl.sensors.NumericSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["sourceVoltagePhaseSyncAngle"], agent));
        inst.overloadAlarm = Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["overloadAlarm"], agent));
        inst.phaseSyncAlarm = Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["phaseSyncAlarm"], agent));
        inst.switchFault = Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["switchFault"], agent));
        return inst;
      }

      public Com.Raritan.Idl.sensors.StateSensor_4_0_0 selectedSource = null;
      public Com.Raritan.Idl.sensors.StateSensor_4_0_0 operationalState = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_0 sourceVoltagePhaseSyncAngle = null;
      public Com.Raritan.Idl.sensors.StateSensor_4_0_0 overloadAlarm = null;
      public Com.Raritan.Idl.sensors.StateSensor_4_0_0 phaseSyncAlarm = null;
      public Com.Raritan.Idl.sensors.StateSensor_4_0_0 switchFault = null;
    }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch_3_1_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings oldSettings = new Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings();
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings newSettings = new Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetLastTransferReasonResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.TransferReason _ret_;
    }
    ...
    public GetLastTransferReasonResult getLastTransferReason() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.TransferReason)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetLastTransferWaveformResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.WaveformSample> _ret_;
    }
    ...
    public GetLastTransferWaveformResult getLastTransferWaveform() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.WaveformSample>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.WaveformSample.Decode(_value, agent)));
      return _ret;
    }
