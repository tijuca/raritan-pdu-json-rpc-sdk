...
namespace Com.Raritan.Idl.net {
  ...
  public class NetworkConfigIPv4 : ICloneable {
    public object Clone() {
      NetworkConfigIPv4 copy = new NetworkConfigIPv4();
    ...
    public static NetworkConfigIPv4 Decode(LightJson.JsonObject json, Agent agent) {
      NetworkConfigIPv4 inst = new NetworkConfigIPv4();
      ...
      inst.netmask = (string)json["netmask"];
