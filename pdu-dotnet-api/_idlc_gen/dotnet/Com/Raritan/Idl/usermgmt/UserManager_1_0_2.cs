...
namespace Com.Raritan.Idl.usermgmt {
  public class UserManager_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("usermgmt.UserManager:1.0.2", null);

    public UserManager_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public UserManager_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new UserManager_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new UserManager_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
