...
package Raritan::RPC::powerlogic::PowerMeter_1_2_5::L2N_plain_total;
...
sub encode {
    ...
    $encoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter_1_2_5::MinMaxReading::encode($in->{'total'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter_1_2_5::MinMaxReading::decode($agent, $in->{'total'});
    return $decoded;
}
