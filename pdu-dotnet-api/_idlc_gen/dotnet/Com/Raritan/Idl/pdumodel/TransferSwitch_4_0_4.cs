...
namespace Com.Raritan.Idl.pdumodel {
  public class TransferSwitch_4_0_4 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch:4.0.4", null);

    public TransferSwitch_4_0_4(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public TransferSwitch_4_0_4(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new TransferSwitch_4_0_4 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new TransferSwitch_4_0_4(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Type type = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Type.STS;
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.selectedSource = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["selectedSource"], agent));
        inst.operationalState = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["operationalState"], agent));
        inst.sourceVoltagePhaseSyncAngle = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["sourceVoltagePhaseSyncAngle"], agent));
        inst.overloadAlarm = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["overloadAlarm"], agent));
        inst.phaseSyncAlarm = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["phaseSyncAlarm"], agent));
        inst.switchFault = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["switchFault"], agent));
        return inst;
      }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch_4_0_4.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public GetLastTransferReasonResult getLastTransferReason() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferReason)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetLastTransferWaveformResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample> _ret_;
    }
    ...
    public GetLastTransferWaveformResult getLastTransferWaveform() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class TransferLogEntry : ICloneable {
      ...
      public static TransferLogEntry Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.reason = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferReason)(int)json["reason"];
        inst.waveform = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample>(json["waveform"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample.Decode(_value, agent)));
        inst.statistics = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.Statistics.Decode(json["statistics"], agent);
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferReason reason = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferReason.REASON_UNKNOWN;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample> waveform = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.WaveformSample>();
    ...
    public class GetTransferLogResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferLogEntry> _ret_;
    }
    ...
    public GetTransferLogResult getTransferLog() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferLogEntry>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_4.TransferLogEntry.Decode(_value, agent)));
      return _ret;
    }
