...
namespace Com.Raritan.Idl.luaservice {
  public class Manager : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("luaservice.Manager:1.0.0", null);

    public Manager(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Manager(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Manager StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Manager(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public SetScriptResult setScript(string name, string script, Com.Raritan.Idl.luaservice.ScriptOptions options) {
    ...
    public AsyncRequest setScript(string name, string script, Com.Raritan.Idl.luaservice.ScriptOptions options, AsyncRpcResponse<SetScriptResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setScript(name, script, options, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setScript(string name, string script, Com.Raritan.Idl.luaservice.ScriptOptions options, AsyncRpcResponse<SetScriptResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["name"] = name;
        _parameters["script"] = script;
    ...
    public SetScriptOptionsResult setScriptOptions(string name, Com.Raritan.Idl.luaservice.ScriptOptions options) {
      var _parameters = new LightJson.JsonObject();
      _parameters["name"] = name;
      _parameters["options"] = options.Encode();
    ...
    public AsyncRequest setScriptOptions(string name, Com.Raritan.Idl.luaservice.ScriptOptions options, AsyncRpcResponse<SetScriptOptionsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setScriptOptions(name, options, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setScriptOptions(string name, Com.Raritan.Idl.luaservice.ScriptOptions options, AsyncRpcResponse<SetScriptOptionsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["name"] = name;
        _parameters["options"] = options.Encode();
    ...
    public GetScriptOptionsResult getScriptOptions(string name) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.options = Com.Raritan.Idl.luaservice.ScriptOptions.Decode(_result["options"], agent);
      return _ret;
    }
    ...
    public GetEnvironmentResult getEnvironment() {
      ...
      _ret._ret_ = Com.Raritan.Idl.luaservice.Environment.Decode(_result["_ret_"], agent);
      return _ret;
    }
