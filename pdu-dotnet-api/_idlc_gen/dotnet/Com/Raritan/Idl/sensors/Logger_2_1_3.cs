...
namespace Com.Raritan.Idl.sensors {
  public class Logger_2_1_3 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Logger:2.1.3", null);

    public Logger_2_1_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Logger_2_1_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Logger_2_1_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Logger_2_1_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Logger_2_1_3.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.sensors.Logger_2_1_3.Settings oldSettings = new Com.Raritan.Idl.sensors.Logger_2_1_3.Settings();
      public Com.Raritan.Idl.sensors.Logger_2_1_3.Settings newSettings = new Com.Raritan.Idl.sensors.Logger_2_1_3.Settings();
    }

    public class LoggedSensorsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Logger_2_1_3.LoggedSensorsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet oldSensors = new Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet();
      public Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet newSensors = new Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet();
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.sensors.Logger_2_1_3.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Logger_2_1_3.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_1_3.Record> recs;
    }
    ...
    public GetSensorRecordsResult getSensorRecords(Com.Raritan.Idl.sensors.Sensor_4_0_1 sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.Record>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.sensors.Logger_2_1_3.Record.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class TimedRecord : ICloneable {
      ...
      public static TimedRecord Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.record = Com.Raritan.Idl.sensors.Logger_2_1_3.Record.Decode(json["record"], agent);
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.sensors.Logger_2_1_3.Record record = new Com.Raritan.Idl.sensors.Logger_2_1_3.Record();
    }

    public class GetSensorTimedRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_1_3.TimedRecord> recs;
    }
    ...
    public GetSensorTimedRecordsResult getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor_4_0_1 sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.TimedRecord>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.sensors.Logger_2_1_3.TimedRecord.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetLoggedSensorsResult {
      public Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet _ret_;
    }
    ...
    public GetLoggedSensorsResult getLoggedSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetLoggedSensorsResult setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet sensors) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setLoggedSensors(sensors, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_1_3.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensors"] = sensors.Encode();
      } catch (Exception e) {
    ...
    public class LogRow : ICloneable {
      ...
      public static LogRow Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.timestamp = new System.DateTime(json["timestamp"]);
        inst.sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.Record>(json["sensorRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.Logger_2_1_3.Record.Decode(_value, agent)));
        inst.peripheralDeviceRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.Record>(json["peripheralDeviceRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.Logger_2_1_3.Record.Decode(_value, agent)));
        return inst;
      }
      ...
      public System.DateTime timestamp = new System.DateTime(0);
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_1_3.Record> sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.Record>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_1_3.Record> peripheralDeviceRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_1_3.Record>();
    }

    public class GetLogRowResult {
      public int _ret_;
      public Com.Raritan.Idl.sensors.Logger_2_1_3.LogRow row;
    }
    ...
    public GetLogRowResult getLogRow(int recid) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.row = Com.Raritan.Idl.sensors.Logger_2_1_3.LogRow.Decode(_result["row"], agent);
      return _ret;
    }
