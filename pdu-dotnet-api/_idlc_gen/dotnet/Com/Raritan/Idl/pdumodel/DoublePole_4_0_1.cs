...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class DoublePole_4_0_1 : ICloneable {
    public object Clone() {
      DoublePole_4_0_1 copy = new DoublePole_4_0_1();
    ...
    public static DoublePole_4_0_1 Decode(LightJson.JsonObject json, Agent agent) {
      DoublePole_4_0_1 inst = new DoublePole_4_0_1();
