...
namespace Com.Raritan.Idl.emdmodel {
  public class Emd_2_2_8 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("emdmodel.Emd:2.2.8", null);

    public Emd_2_2_8(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Emd_2_2_8(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Emd_2_2_8 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Emd_2_2_8(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("emdmodel.Emd_2_2_8.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings oldSettings = new Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings();
      public Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings newSettings = new Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.emdmodel.Emd_2_2_8.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd_2_2_8.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd_2_2_8.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
