...
namespace Com.Raritan.Idl.peripheral {
  public class DeviceManager_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager:2.0.0", null);

    public DeviceManager_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DeviceManager_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DeviceManager_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DeviceManager_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.ZCoordMode)(int)json["zCoordMode"];
        ...
        inst.defaultThresholdsMap = DictionaryHelper.Create(json["defaultThresholdsMap"].AsJsonArray.Select(
          _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Thresholds>(_value["key"], Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Thresholds.Decode(_value["value"], agent))));
        return inst;
      }

      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.ZCoordMode zCoordMode = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.ZCoordMode.RACKUNITS;
      public bool autoManageNewDevices = false;
      public float deviceAltitude = 0.0f;
      public int presenceDetectionTimeout = 0;
      public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Thresholds> defaultThresholdsMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Thresholds>();
    }
    ...
    public class DeviceTypeInfo : ICloneable {
      ...
      public static DeviceTypeInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.defaultRange = Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Range.Decode(json["defaultRange"], agent);
      ...
      public string name = "";
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Range defaultRange = new Com.Raritan.Idl.sensors.NumericSensor_4_0_0.Range();
      public int defaultDecDigits = 0;
    }

    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings oldSettings = new Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings();
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings newSettings = new Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings();
    }

    public class DeviceEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.DeviceEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.peripheral.Device_2_0_0 device = new Com.Raritan.Idl.peripheral.Device_2_0_0();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.Device_2_0_0> allDevices = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.Device_2_0_0>();
    }

    public class DeviceAddedEvent : Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.DeviceAddedEvent:1.0.0", Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceEvent.typeInfo);

    }

    public class DeviceRemovedEvent : Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.DeviceRemovedEvent:1.0.0", Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceEvent.typeInfo);

    }

    public class UnknownDeviceAttachedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.UnknownDeviceAttachedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class DeviceFirmwareUpdateStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.DeviceFirmwareUpdateStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public string oldVersion = "";
      public string newVersion = "";
      public string serial = "";
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceFirmwareUpdateState state = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceFirmwareUpdateState.UPDATE_STARTED;
    }

    public class PackageEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.PackageEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.peripheral.PackageInfo_2_0_0 packageInfo = new Com.Raritan.Idl.peripheral.PackageInfo_2_0_0();
    ...
    public class PackageAddedEvent : Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.PackageEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.PackageAddedEvent:1.0.0", Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.PackageEvent.typeInfo);

    }

    public class PackageRemovedEvent : Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.PackageEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_2_0_0.PackageRemovedEvent:1.0.0", Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.PackageEvent.typeInfo);
    ...
    public class GetDeviceSlotsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceSlot_2_0_0> _ret_;
    }
    ...
    public GetDeviceSlotsResult getDeviceSlots() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceSlot_2_0_0>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetDeviceSlotResult {
      public Com.Raritan.Idl.peripheral.DeviceSlot_2_0_0 _ret_;
    }
    ...
    public GetDeviceSlotResult getDeviceSlot(int idx) {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceSlot_2_0_0.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetDiscoveredDevicesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.Device_2_0_0> _ret_;
    }
    ...
    public GetDiscoveredDevicesResult getDiscoveredDevices() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.Device_2_0_0>(_result["_ret_"].AsJsonArray.Select(
        _value => ((Com.Raritan.Idl.peripheral.Device_2_0_0)ValueObjectCodec.DecodeAs(_value, agent, Com.Raritan.Idl.peripheral.Device_2_0_0.typeInfo))));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDeviceTypeInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceTypeInfo> _ret_;
    }
    ...
    public GetDeviceTypeInfosResult getDeviceTypeInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceTypeInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.DeviceTypeInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
