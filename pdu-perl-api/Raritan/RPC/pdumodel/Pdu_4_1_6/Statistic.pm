...
package Raritan::RPC::pdumodel::Pdu_4_1_6::Statistic;
...
sub encode {
    ...
    $encoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_3_0_2::Statistics::encode($in->{'peripheralStats'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_3_0_2::Statistics::decode($agent, $in->{'peripheralStats'});
    return $decoded;
}
