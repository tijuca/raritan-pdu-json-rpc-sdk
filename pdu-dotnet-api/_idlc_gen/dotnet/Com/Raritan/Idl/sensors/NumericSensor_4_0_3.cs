...
namespace Com.Raritan.Idl.sensors {
  public class NumericSensor_4_0_3 : Com.Raritan.Idl.sensors.Sensor_4_0_3 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor:4.0.3", null);

    public NumericSensor_4_0_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public NumericSensor_4_0_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new NumericSensor_4_0_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new NumericSensor_4_0_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.range = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Range.Decode(json["range"], agent);
        inst.thresholdCaps = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.ThresholdCapabilities.Decode(json["thresholdCaps"], agent);
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Range range = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Range();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.ThresholdCapabilities thresholdCaps = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.ThresholdCapabilities();
    }
    ...
    public class Reading : ICloneable {
      ...
      public static Reading Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.status = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading.Status.Decode(json["status"], agent);
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading.Status status = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading.Status();
      public bool valid = false;
      public double value = 0.0;
    }

    public class ReadingChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_3.ReadingChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading newReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading();
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_3.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading oldReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading newReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading();
    }

    public class MetaDataChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_3.MetaDataChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData oldMetaData = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData newMetaData = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData();
    }

    public class ThresholdsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_3.ThresholdsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds oldThresholds = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds newThresholds = new Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDefaultThresholdsResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds _ret_;
    }
    ...
    public GetDefaultThresholdsResult getDefaultThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds thresh) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresh, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresh"] = thresh.Encode();
      } catch (Exception e) {
    ...
    public class GetReadingResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading _ret_;
    }
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
