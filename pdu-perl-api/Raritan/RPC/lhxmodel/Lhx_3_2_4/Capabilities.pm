...
package Raritan::RPC::lhxmodel::Lhx_3_2_4::Capabilities;
...
sub encode {
    my ($in) = @_;
    my $encoded = {};
    $encoded->{'alerts'} = Raritan::RPC::lhxmodel::Lhx_3_2_4::AlertStatus::encode($in->{'alerts'});
    $encoded->{'features'} = [];
...
sub decode {
    my ($agent, $in) = @_;
    my $decoded = {};
    $decoded->{'alerts'} = Raritan::RPC::lhxmodel::Lhx_3_2_4::AlertStatus::decode($agent, $in->{'alerts'});
    $decoded->{'features'} = {};
