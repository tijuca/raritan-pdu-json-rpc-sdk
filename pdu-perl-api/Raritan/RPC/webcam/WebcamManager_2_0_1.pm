...
package Raritan::RPC::webcam::WebcamManager_2_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "webcam.WebcamManager:2.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::webcam::WebcamManager_2_0_1::typeId;
...
Raritan::RPC::Registry::registerProxyClass('webcam.WebcamManager', 2, 0, 1, 'Raritan::RPC::webcam::WebcamManager_2_0_1');
1;
