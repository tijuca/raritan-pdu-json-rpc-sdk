...
namespace Com.Raritan.Idl.peripheral {
  public class DeviceManager_1_0_3 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager:1.0.3", null);

    public DeviceManager_1_0_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DeviceManager_1_0_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DeviceManager_1_0_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DeviceManager_1_0_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.ZCoordMode)(int)json["zCoordMode"];
        ...
        inst.defaultThresholdsMap = DictionaryHelper.Create(json["defaultThresholdsMap"].AsJsonArray.Select(
          _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds>(_value["key"], Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds.Decode(_value["value"], agent))));
        return inst;
      }

      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.ZCoordMode zCoordMode = Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.ZCoordMode.RACKUNITS;
      public bool autoManageNewDevices = false;
      public float deviceAltitude = 0.0f;
      public int presenceDetectionTimeout = 0;
      public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds> defaultThresholdsMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds>();
    }
    ...
    public class DeviceTypeInfo : ICloneable {
      ...
      public static DeviceTypeInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.defaultRange = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range.Decode(json["defaultRange"], agent);
      ...
      public string name = "";
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range defaultRange = new Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range();
    ...
    public class GetDeviceSlotsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceSlot> _ret_;
    }
    ...
    public GetDeviceSlotsResult getDeviceSlots() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceSlot>(_result["_ret_"].AsJsonArray.Select(
    ...
    public GetDeviceSlotResult getDeviceSlot(int idx) {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceSlot.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetDiscoveredDevicesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.Device> _ret_;
    }
    ...
    public GetDiscoveredDevicesResult getDiscoveredDevices() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.Device>(_result["_ret_"].AsJsonArray.Select(
        _value => ((Com.Raritan.Idl.peripheral.Device)ValueObjectCodec.DecodeAs(_value, agent, Com.Raritan.Idl.peripheral.Device.typeInfo))));
      return _ret;
    }
    ...
    public class GetDiscoveredPackageInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.PackageInfo> _ret_;
    }
    ...
    public GetDiscoveredPackageInfosResult getDiscoveredPackageInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.PackageInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.PackageInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDeviceTypeInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.DeviceTypeInfo> _ret_;
    }
    ...
    public GetDeviceTypeInfosResult getDeviceTypeInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.DeviceTypeInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.DeviceTypeInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_1_0_3.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
