...
namespace Com.Raritan.Idl.peripheral {
  ...
  public class PackageInfo_2_0_1 : ICloneable {
    public object Clone() {
      PackageInfo_2_0_1 copy = new PackageInfo_2_0_1();
    ...
    public static PackageInfo_2_0_1 Decode(LightJson.JsonObject json, Agent agent) {
      PackageInfo_2_0_1 inst = new PackageInfo_2_0_1();
      inst.state = (Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.State)(int)json["state"];
      ...
      inst.hwInfo = Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.HardwareInfo.Decode(json["hwInfo"], agent);
      inst.fwInfo = Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo.Decode(json["fwInfo"], agent);
      return inst;
    }
    ...
    public class FirmwareInfo : ICloneable {
      ...
      public static FirmwareInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.version = Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo.Version.Decode(json["version"], agent);
      ...
      public Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo.Version version = new Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo.Version();
      public System.DateTime updateDate = new System.DateTime(0);
    }
    public Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.State state = Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.State.NORMAL;
    ...
    public Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.HardwareInfo hwInfo = new Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.HardwareInfo();
    public Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo fwInfo = new Com.Raritan.Idl.peripheral.PackageInfo_2_0_1.FirmwareInfo();
  }
}
