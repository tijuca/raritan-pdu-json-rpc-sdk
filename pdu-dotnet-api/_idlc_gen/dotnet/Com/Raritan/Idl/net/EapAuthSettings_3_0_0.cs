...
namespace Com.Raritan.Idl.net {
  ...
  public class EapAuthSettings_3_0_0 : ICloneable {
    public object Clone() {
      EapAuthSettings_3_0_0 copy = new EapAuthSettings_3_0_0();
      copy.identity = this.identity;
      copy.password = this.password;
      copy.clearPassword = this.clearPassword;
      copy.clientCertChain = this.clientCertChain;
      copy.clientPrivKey = this.clientPrivKey;
      copy.clearClientPrivKey = this.clearClientPrivKey;
      copy.clientPrivKeyPassword = this.clientPrivKeyPassword;
    ...
    public LightJson.JsonObject Encode() {
      ...
      json["clientCertChain"] = this.clientCertChain;
      json["clientPrivKey"] = this.clientPrivKey;
      json["clearClientPrivKey"] = this.clearClientPrivKey;
      json["clientPrivKeyPassword"] = this.clientPrivKeyPassword;
    ...
    public static EapAuthSettings_3_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      EapAuthSettings_3_0_0 inst = new EapAuthSettings_3_0_0();
      inst.identity = (string)json["identity"];
      inst.password = (string)json["password"];
      inst.clearPassword = (bool)json["clearPassword"];
      inst.clientCertChain = (string)json["clientCertChain"];
      inst.clientPrivKey = (string)json["clientPrivKey"];
      inst.clearClientPrivKey = (bool)json["clearClientPrivKey"];
      inst.clientPrivKeyPassword = (string)json["clientPrivKeyPassword"];
      inst.outerMethod = (Com.Raritan.Idl.net.EapOuterAuthMethod_2_0_0)(int)json["outerMethod"];
      inst.innerMethod = (Com.Raritan.Idl.net.EapInnerAuthMethod_2_0_0)(int)json["innerMethod"];
    ...
    public bool clearClientPrivKey = false;
    public string clientPrivKeyPassword = "";
    public Com.Raritan.Idl.net.EapOuterAuthMethod_2_0_0 outerMethod = Com.Raritan.Idl.net.EapOuterAuthMethod_2_0_0.EAP_PEAP;
    public Com.Raritan.Idl.net.EapInnerAuthMethod_2_0_0 innerMethod = Com.Raritan.Idl.net.EapInnerAuthMethod_2_0_0.INNER_EAP_MSCHAPv2;
