...
namespace Com.Raritan.Idl.pdumodel {
  public class Controller : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Controller:1.0.0", null);

    public Controller(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Controller(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Controller StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Controller(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.Controller.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.Controller.Type type = Com.Raritan.Idl.pdumodel.Controller.Type.OUTLET_CTRL;
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Controller.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Controller.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
