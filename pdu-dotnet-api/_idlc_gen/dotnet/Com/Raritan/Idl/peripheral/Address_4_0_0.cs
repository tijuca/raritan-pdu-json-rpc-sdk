...
namespace Com.Raritan.Idl.peripheral {
  ...
  public class Address_4_0_0 : ICloneable {
    public object Clone() {
      Address_4_0_0 copy = new Address_4_0_0();
    ...
    public static Address_4_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      Address_4_0_0 inst = new Address_4_0_0();
