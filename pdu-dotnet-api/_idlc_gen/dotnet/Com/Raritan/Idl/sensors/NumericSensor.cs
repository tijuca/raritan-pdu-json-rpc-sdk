...
namespace Com.Raritan.Idl.sensors {
  public class NumericSensor : Com.Raritan.Idl.sensors.Sensor {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor:1.0.0", null);

    public NumericSensor(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public NumericSensor(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new NumericSensor StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new NumericSensor(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.range = Com.Raritan.Idl.sensors.NumericSensor.Range.Decode(json["range"], agent);
        return inst;
      }
    ...
    public class Reading : ICloneable {
      ...
      public static Reading Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.status = Com.Raritan.Idl.sensors.NumericSensor.Reading.Status.Decode(json["status"], agent);
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public GetDefaultThresholdsResult getDefaultThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor.Thresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.sensors.NumericSensor.Thresholds thresh) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresh, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresh"] = thresh.Encode();
      } catch (Exception e) {
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
