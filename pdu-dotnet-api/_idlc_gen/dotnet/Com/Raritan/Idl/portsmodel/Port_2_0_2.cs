...
namespace Com.Raritan.Idl.portsmodel {
  public class Port_2_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("portsmodel.Port:2.0.2", null);

    public Port_2_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Port_2_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Port_2_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Port_2_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class DetectionMode : ICloneable {
      ...
      public static DetectionMode Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionType)(int)json["type"];
        inst.pinnedDeviceType = (string)json["pinnedDeviceType"];
        return inst;
      }

      public Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionType type = Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionType.AUTO;
    ...
    public class Properties : ICloneable {
      ...
      public static Properties Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.mode = Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode.Decode(json["mode"], agent);
      ...
      public string name = "";
      public string label = "";
      public Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode mode = new Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode();
    ...
    public class PropertiesChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("portsmodel.Port_2_0_2.PropertiesChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties oldProperties = new Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties();
      public Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties newProperties = new Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties();
    }

    public class DeviceChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("portsmodel.Port_2_0_2.DeviceChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class GetPropertiesResult {
      public Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties _ret_;
    }
    ...
    public GetPropertiesResult getProperties() {
      ...
      _ret._ret_ = Com.Raritan.Idl.portsmodel.Port_2_0_2.Properties.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetDetectionModeResult setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode mode) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode mode, AsyncRpcResponse<SetDetectionModeResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setDetectionMode(mode, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_2.DetectionMode mode, AsyncRpcResponse<SetDetectionModeResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["mode"] = mode.Encode();
      } catch (Exception e) {
    ...
    public class GetFuseResult {
      public Com.Raritan.Idl.portsmodel.PortFuse _ret_;
    }

    public GetFuseResult getFuse() {
      JsonObject _parameters = null;
      var _result = RpcCall("getFuse", _parameters);
      var _ret = new GetFuseResult();
      _ret._ret_ = Com.Raritan.Idl.portsmodel.PortFuse.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }

    public AsyncRequest getFuse(AsyncRpcResponse<GetFuseResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getFuse(rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getFuse(AsyncRpcResponse<GetFuseResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      JsonObject _parameters = null;
      return RpcCall("getFuse", _parameters,
        _result => {
          try {
            var _ret = new GetFuseResult();
            _ret._ret_ = Com.Raritan.Idl.portsmodel.PortFuse.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
