...
package Raritan::RPC::pdumodel::Outlet_2_1_1::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_1_1::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_1_1::LedState::decode($agent, $in->{'ledState'});
