...
package Raritan::RPC::net::Settings_2_0_0;
...
sub encode {
    ...
    foreach my $key0 (keys %{$in->{'wlanMap'}}) {
        ...
        my $elem0 = {};
        $elem0->{'key'} = "$key0";
        $elem0->{'value'} = Raritan::RPC::net::WlanSettings_2_0_0::encode($value0);
...
sub decode {
    ...
    for (my $i0 = 0; $i0 <= $#{$in->{'wlanMap'}}; $i0++) {
        ...
        my $value0 = Raritan::RPC::net::WlanSettings_2_0_0::decode($agent, $in->{'wlanMap'}->[$i0]->{'value'});
