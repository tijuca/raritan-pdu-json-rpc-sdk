...
namespace Com.Raritan.Idl.sensors {
  public class ExternalSensorManager_3_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.ExternalSensorManager:3.0.0", null);

    public ExternalSensorManager_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public ExternalSensorManager_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new ExternalSensorManager_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new ExternalSensorManager_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.ZCoordMode)(int)json["zCoordMode"];
        inst.deviceAltitude = (float)json["deviceAltitude"];
        return inst;
      }

      public Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.ZCoordMode zCoordMode = Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.ZCoordMode.RACKUNITS;
    ...
    public class GetExternalSensorSlotsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.ExternalSensorSlot_3_0_0> _ret_;
    }
    ...
    public GetExternalSensorSlotsResult getExternalSensorSlots() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.ExternalSensorSlot_3_0_0>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetDiscoveredExternalSensorsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.ExternalSensorData_3_0_0> _ret_;
    }
    ...
    public GetDiscoveredExternalSensorsResult getDiscoveredExternalSensors() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.ExternalSensorData_3_0_0>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.sensors.ExternalSensorData_3_0_0.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.ExternalSensorManager_3_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
