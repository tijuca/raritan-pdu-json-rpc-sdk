...
package Raritan::RPC::pdumodel::Outlet_2_1_2::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_1_2::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_1_2::LedState::decode($agent, $in->{'ledState'});
