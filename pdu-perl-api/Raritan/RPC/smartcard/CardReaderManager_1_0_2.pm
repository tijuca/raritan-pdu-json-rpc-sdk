...
package Raritan::RPC::smartcard::CardReaderManager_1_0_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "smartcard.CardReaderManager:1.0.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::smartcard::CardReaderManager_1_0_2::typeId;
...
Raritan::RPC::Registry::registerProxyClass('smartcard.CardReaderManager', 1, 0, 2, 'Raritan::RPC::smartcard::CardReaderManager_1_0_2');
1;
