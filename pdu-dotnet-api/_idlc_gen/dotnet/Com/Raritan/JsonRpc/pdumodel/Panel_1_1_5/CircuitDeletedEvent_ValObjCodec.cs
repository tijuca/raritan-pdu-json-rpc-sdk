...
namespace Com.Raritan.JsonRpc.pdumodel.Panel_1_1_5 {
  public class CircuitDeletedEvent_ValObjCodec : Com.Raritan.JsonRpc._event.UserEvent_ValObjCodec {
    ...
    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.pdumodel.Panel_1_1_5.CircuitDeletedEvent.typeInfo, new CircuitDeletedEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.pdumodel.Panel_1_1_5.CircuitDeletedEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.pdumodel.Panel_1_1_5.CircuitDeletedEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.pdumodel.Panel_1_1_5.CircuitDeletedEvent();
      } else {
        inst = (Com.Raritan.Idl.pdumodel.Panel_1_1_5.CircuitDeletedEvent)vo;
      }
