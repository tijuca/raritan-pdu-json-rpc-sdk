...
namespace Com.Raritan.Idl.lhxmodel {
  public class Sensor_4_0_1 : Com.Raritan.Idl.sensors.Sensor_4_0_1 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor:4.0.1", null);
    ...
    public class ThresholdsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_1.ThresholdsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds oldThresholds = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds();
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds newThresholds = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds();
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_1.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading oldReading = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading();
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading newReading = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading();
    }

    public class ReadingChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Sensor_4_0_1.ReadingChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetThresholdsResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds _ret_;
    }
    ...
    public GetThresholdsResult getThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds thresholds) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds thresholds, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresholds, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.NumThresholds thresholds, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresholds"] = thresholds.Encode();
      } catch (Exception e) {
    ...
    public class GetReadingResult {
      public Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading _ret_;
    }
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
