...
namespace Com.Raritan.Idl.net {
  public class Net_2_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("net.Net:2.0.2", null);

    public Net_2_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Net_2_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Net_2_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Net_2_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
