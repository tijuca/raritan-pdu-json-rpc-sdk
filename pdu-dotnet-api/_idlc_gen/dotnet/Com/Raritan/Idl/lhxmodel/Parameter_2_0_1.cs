...
namespace Com.Raritan.Idl.lhxmodel {
  public class Parameter_2_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Parameter:2.0.1", null);

    public Parameter_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Parameter_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Parameter_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Parameter_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.unit = (Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Unit)(int)json["unit"];
      ...
      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Unit unit = Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Unit.NONE;
      public string id = "";
    ...
    public class Value : ICloneable {
      ...
      public static Value Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.status = Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Status.Decode(json["status"], agent);
        inst.value = (double)json["value"];
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Status status = new Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Status();
      public double value = 0.0;
    }

    public class MetaDataChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Parameter_2_0_1.MetaDataChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData oldMetaData = new Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData();
      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData newMetaData = new Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData();
    }

    public class ValueChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("lhxmodel.Parameter_2_0_1.ValueChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Value newValue = new Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Value();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetValueResult {
      public Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Value _ret_;
    }
    ...
    public GetValueResult getValue() {
      ...
      _ret._ret_ = Com.Raritan.Idl.lhxmodel.Parameter_2_0_1.Value.Decode(_result["_ret_"], agent);
      return _ret;
    }
