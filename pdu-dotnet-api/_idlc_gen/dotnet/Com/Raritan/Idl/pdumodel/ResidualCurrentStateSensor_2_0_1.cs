...
namespace Com.Raritan.Idl.pdumodel {
  public class ResidualCurrentStateSensor_2_0_1 : Com.Raritan.Idl.sensors.StateSensor_4_0_1 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.ResidualCurrentStateSensor:2.0.1", null);

    public ResidualCurrentStateSensor_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public ResidualCurrentStateSensor_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new ResidualCurrentStateSensor_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new ResidualCurrentStateSensor_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
