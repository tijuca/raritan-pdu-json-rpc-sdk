...
namespace Com.Raritan.Idl.pdumodel {
  public class MemoryMapController : Com.Raritan.Idl.pdumodel.Controller {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.MemoryMapController:1.0.0", null);

    public MemoryMapController(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public MemoryMapController(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new MemoryMapController StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new MemoryMapController(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
