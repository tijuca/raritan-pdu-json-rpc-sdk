...
namespace Com.Raritan.JsonRpc.pdumodel.PowerMeterController {
  public class PowerMeterDeletedEvent_ValObjCodec : Com.Raritan.JsonRpc._event.UserEvent_ValObjCodec {
    ...
    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.pdumodel.PowerMeterController.PowerMeterDeletedEvent.typeInfo, new PowerMeterDeletedEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.pdumodel.PowerMeterController.PowerMeterDeletedEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.pdumodel.PowerMeterController.PowerMeterDeletedEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.pdumodel.PowerMeterController.PowerMeterDeletedEvent();
      } else {
        inst = (Com.Raritan.Idl.pdumodel.PowerMeterController.PowerMeterDeletedEvent)vo;
      }
