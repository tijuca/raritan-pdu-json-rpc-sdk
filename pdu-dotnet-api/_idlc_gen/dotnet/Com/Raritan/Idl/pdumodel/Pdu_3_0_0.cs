...
namespace Com.Raritan.Idl.pdumodel {
  public class Pdu_3_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu:3.0.0", null);

    public Pdu_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Pdu_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Pdu_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Pdu_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerSupplyStatus = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.StateSensor_4_0_0>(json["powerSupplyStatus"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.StateSensor_4_0_0.StaticCast(ObjectProxy.Decode(_value, agent))));
      ...
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.StateSensor_4_0_0> powerSupplyStatus = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.StateSensor_4_0_0>();
    ...
    public class Statistic : ICloneable {
      ...
      public static Statistic Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.peripheralStats = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Statistics.Decode(json["peripheralStats"], agent);
        return inst;
      }
      ...
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Statistics peripheralStats = new Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.Statistics();
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Pdu_3_0_0.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.StartupState startupState = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.StartupState.SS_ON;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_3_0_0.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings();
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings newSettings = new Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings();
    }

    public class LoadSheddingModeChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_3_0_0.LoadSheddingModeChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool enabled = false;
    }

    public class OutletSequenceStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_3_0_0.OutletSequenceStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.OutletSequenceState newState = new Com.Raritan.Idl.pdumodel.Pdu_3_0_0.OutletSequenceState();
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorLoggerResult {
      public Com.Raritan.Idl.sensors.Logger_2_1_2 _ret_;
    }
    ...
    public GetSensorLoggerResult getSensorLogger() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Logger_2_1_2.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetOutletsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Outlet_1_5_6> _ret_;
    }
    ...
    public GetOutletsResult getOutlets() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Outlet_1_5_6>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.Outlet_1_5_6.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetOverCurrentProtectorsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.OverCurrentProtector_2_1_2> _ret_;
    }
    ...
    public GetOverCurrentProtectorsResult getOverCurrentProtectors() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.OverCurrentProtector_2_1_2>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.OverCurrentProtector_2_1_2.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetInletsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Inlet_1_2_6> _ret_;
    }
    ...
    public GetInletsResult getInlets() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Inlet_1_2_6>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.Inlet_1_2_6.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetTransferSwitchesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1> _ret_;
    }
    ...
    public GetTransferSwitchesResult getTransferSwitches() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_3_1_1.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetPeripheralDeviceManagerResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_2_0_0 _ret_;
    }
    ...
    public GetPeripheralDeviceManagerResult getPeripheralDeviceManager() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_2_0_0.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetBeeperResult {
      public Com.Raritan.Idl.hmi.InternalBeeper _ret_;
    }
    ...
    public GetBeeperResult getBeeper() {
      ...
      _ret._ret_ = Com.Raritan.Idl.hmi.InternalBeeper.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public SetAllOutletPowerStatesResult setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState pstate) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState pstate, AsyncRpcResponse<SetAllOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setAllOutletPowerStates(pstate, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState pstate, AsyncRpcResponse<SetAllOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["pstate"] = (int)pstate;
      } catch (Exception e) {
    ...
    public SetMultipleOutletPowerStatesResult setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState state, bool respectSequence) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setMultipleOutletPowerStates(outletNumbers, state, respectSequence, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_1_5_6.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["outletNumbers"] = new JsonArray(outletNumbers.Select(
          _value => (JsonValue)(_value)));
    ...
    public class GetStatisticResult {
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Statistic _ret_;
    }
    ...
    public GetStatisticResult getStatistic() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.Statistic.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletSequenceStateResult {
      public Com.Raritan.Idl.pdumodel.Pdu_3_0_0.OutletSequenceState _ret_;
    }
    ...
    public GetOutletSequenceStateResult getOutletSequenceState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_3_0_0.OutletSequenceState.Decode(_result["_ret_"], agent);
      return _ret;
    }
