...
namespace Com.Raritan.JsonRpc.peripheral {
  public class Device_3_0_0_ValObjCodec : ValueObjectCodec
 {

    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.peripheral.Device_3_0_0.typeInfo, new Device_3_0_0_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      var inst = (Com.Raritan.Idl.peripheral.Device_3_0_0)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.peripheral.Device_3_0_0 inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.peripheral.Device_3_0_0();
      } else {
        inst = (Com.Raritan.Idl.peripheral.Device_3_0_0)vo;
      }
      inst.deviceID = Com.Raritan.Idl.peripheral.DeviceID_3_0_0.Decode(json["deviceID"], agent);
      ...
      inst.device = Com.Raritan.Idl.sensors.Sensor_4_0_1.StaticCast(ObjectProxy.Decode(json["device"], agent));
      return inst;
    }
