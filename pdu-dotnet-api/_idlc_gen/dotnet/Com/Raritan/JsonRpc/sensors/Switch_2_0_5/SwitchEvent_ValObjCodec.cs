...
namespace Com.Raritan.JsonRpc.sensors.Switch_2_0_5 {
  public class SwitchEvent_ValObjCodec : Com.Raritan.JsonRpc._event.UserEvent_ValObjCodec {

    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.sensors.Switch_2_0_5.SwitchEvent.typeInfo, new SwitchEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.sensors.Switch_2_0_5.SwitchEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.sensors.Switch_2_0_5.SwitchEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.sensors.Switch_2_0_5.SwitchEvent();
      } else {
        inst = (Com.Raritan.Idl.sensors.Switch_2_0_5.SwitchEvent)vo;
      }
