...
namespace Com.Raritan.Idl.net {
  ...
  public class InterfaceIpSettings_2_0_0 : ICloneable {
    public object Clone() {
      InterfaceIpSettings_2_0_0 copy = new InterfaceIpSettings_2_0_0();
    ...
    public static InterfaceIpSettings_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      InterfaceIpSettings_2_0_0 inst = new InterfaceIpSettings_2_0_0();
