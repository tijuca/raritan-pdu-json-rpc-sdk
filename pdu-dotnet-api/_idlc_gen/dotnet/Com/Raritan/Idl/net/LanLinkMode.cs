...
namespace Com.Raritan.Idl.net {
  ...
  public class LanLinkMode : ICloneable {
    public object Clone() {
      LanLinkMode copy = new LanLinkMode();
    ...
    public static LanLinkMode Decode(LightJson.JsonObject json, Agent agent) {
      LanLinkMode inst = new LanLinkMode();
