...
package Raritan::RPC::net::Info_1_0_1;
...
sub encode {
    ...
    foreach my $key0 (keys %{$in->{'ethMap'}}) {
        ...
        my $elem0 = {};
        $elem0->{'key'} = "$key0";
        $elem0->{'value'} = Raritan::RPC::net::EthInfo_1_0_1::encode($value0);
...
sub decode {
    ...
    for (my $i0 = 0; $i0 <= $#{$in->{'ethMap'}}; $i0++) {
        ...
        my $value0 = Raritan::RPC::net::EthInfo_1_0_1::decode($agent, $in->{'ethMap'}->[$i0]->{'value'});
