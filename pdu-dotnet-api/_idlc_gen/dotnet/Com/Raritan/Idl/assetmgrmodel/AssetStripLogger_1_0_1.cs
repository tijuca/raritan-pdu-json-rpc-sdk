...
namespace Com.Raritan.Idl.assetmgrmodel {
  public class AssetStripLogger_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStripLogger:1.0.1", null);

    public AssetStripLogger_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public AssetStripLogger_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new AssetStripLogger_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new AssetStripLogger_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Record : ICloneable {
      ...
      public static Record Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.RecordType)(int)json["type"];
        ...
        inst.state = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_0.State)(int)json["state"];
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.RecordType type = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.RecordType.EMPTY;
      ...
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_0.State state = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_0.State.DISCONNECTED;
    }
    ...
    public GetInfoResult getInfo() {
      ...
      _ret._ret_ = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.Info.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.Record> records;
    }
    ...
    public GetRecordsResult getRecords(int id, int count) {
      ...
      _ret.records = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.Record>(_result["records"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.assetmgrmodel.AssetStripLogger_1_0_1.Record.Decode(_value, agent)));
      return _ret;
    }
