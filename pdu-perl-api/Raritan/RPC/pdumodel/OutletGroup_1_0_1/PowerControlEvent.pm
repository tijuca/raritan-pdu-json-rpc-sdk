...
package Raritan::RPC::pdumodel::OutletGroup_1_0_1::PowerControlEvent;

use constant typeId => "pdumodel.OutletGroup_1_0_1.PowerControlEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('pdumodel.OutletGroup_1_0_1.PowerControlEvent', 1, 0, 0, 'Raritan::RPC::pdumodel::OutletGroup_1_0_1::PowerControlEvent');
1;
