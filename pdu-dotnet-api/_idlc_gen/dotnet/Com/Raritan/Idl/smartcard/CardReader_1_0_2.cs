...
namespace Com.Raritan.Idl.smartcard {
  public class CardReader_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("smartcard.CardReader:1.0.2", null);

    public CardReader_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public CardReader_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new CardReader_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new CardReader_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class CardEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("smartcard.CardReader_1_0_2.CardEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardInformation cardInfo = new Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardInformation();
    }

    public class CardInsertedEvent : Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("smartcard.CardReader_1_0_2.CardInsertedEvent:1.0.0", Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardEvent.typeInfo);

    }

    public class CardRemovedEvent : Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("smartcard.CardReader_1_0_2.CardRemovedEvent:1.0.0", Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardEvent.typeInfo);

    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.smartcard.CardReader_1_0_2.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.smartcard.CardReader_1_0_2.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetCardInformationResult {
      public int _ret_;
      public Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardInformation cardInfo;
    }
    ...
    public GetCardInformationResult getCardInformation() {
      ...
      _ret.cardInfo = Com.Raritan.Idl.smartcard.CardReader_1_0_2.CardInformation.Decode(_result["cardInfo"], agent);
      return _ret;
    }
