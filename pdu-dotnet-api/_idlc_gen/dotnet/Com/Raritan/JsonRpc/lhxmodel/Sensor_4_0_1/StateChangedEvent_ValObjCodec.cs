...
namespace Com.Raritan.JsonRpc.lhxmodel.Sensor_4_0_1 {
  public class StateChangedEvent_ValObjCodec : Com.Raritan.JsonRpc.idl.Event_ValObjCodec {
    ...
    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.StateChangedEvent.typeInfo, new StateChangedEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.StateChangedEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.StateChangedEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.StateChangedEvent();
      } else {
        inst = (Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.StateChangedEvent)vo;
      }
      base.DecodeValObj(vo, json, agent);
      inst.oldReading = Com.Raritan.Idl.lhxmodel.Sensor_4_0_1.Reading.Decode(json["oldReading"], agent);
