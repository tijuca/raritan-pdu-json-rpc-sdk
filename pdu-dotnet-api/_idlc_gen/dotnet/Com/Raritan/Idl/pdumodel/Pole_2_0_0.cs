...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class Pole_2_0_0 : ICloneable {
    public object Clone() {
      Pole_2_0_0 copy = new Pole_2_0_0();
    ...
    public static Pole_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      Pole_2_0_0 inst = new Pole_2_0_0();
