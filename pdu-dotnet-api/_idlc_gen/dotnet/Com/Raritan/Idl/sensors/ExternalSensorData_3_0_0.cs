...
namespace Com.Raritan.Idl.sensors {
  ...
  public class ExternalSensorData_3_0_0 : ICloneable {
    public object Clone() {
      ExternalSensorData_3_0_0 copy = new ExternalSensorData_3_0_0();
    ...
    public static ExternalSensorData_3_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      ExternalSensorData_3_0_0 inst = new ExternalSensorData_3_0_0();
