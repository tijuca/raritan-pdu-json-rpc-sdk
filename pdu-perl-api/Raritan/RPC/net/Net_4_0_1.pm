...
package Raritan::RPC::net::Net_4_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "net.Net:4.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::net::Net_4_0_1::typeId;
...
use constant ERR_WLAN_IF_INVALID_EAP_AUTH_SERVER_NAME => 607;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::net::Settings_2_0_0::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::net::Settings_2_0_0::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('net.Net', 4, 0, 1, 'Raritan::RPC::net::Net_4_0_1');
1;
