...
namespace Com.Raritan.Idl.assetmgrmodel {
  public class AssetStrip_2_0_5 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip:2.0.5", null);

    public AssetStrip_2_0_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public AssetStrip_2_0_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new AssetStrip_2_0_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new AssetStrip_2_0_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class StripInfo : ICloneable {
      ...
      public static StripInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.cascadeState = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.CascadeState)(int)json["cascadeState"];
        return inst;
      }
      ...
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.CascadeState cascadeState = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.CascadeState.CASCADE_ACTIVE;
    }
    ...
    public class RackUnitInfo : ICloneable {
      ...
      public static RackUnitInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagType)(int)json["type"];
      ...
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagType type = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagType.SINGLE;
      public int size = 0;
    ...
    public class StripInfoChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.StripInfoChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo oldInfo = new Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo();
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo newInfo = new Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo();
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State oldState = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State.DISCONNECTED;
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State newState = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State.DISCONNECTED;
    ...
    public class RackUnitChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.RackUnitChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public int rackUnitNumber = 0;
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo rackUnit = new Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo();
    }
    ...
    public class TagChangeInfo : ICloneable {
      ...
      public static TagChangeInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.tag = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo.Decode(json["tag"], agent);
        inst.info = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo.Decode(json["info"], agent);
        inst.parentBladeTagId = (string)json["parentBladeTagId"];
        inst.slotPosition = (int)json["slotPosition"];
        return inst;
      }

      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo tag = new Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo();
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo info = new Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo();
      public string parentBladeTagId = "";
      public int slotPosition = 0;
    }

    public class TagEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.TagEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagChangeInfo> tags = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagChangeInfo>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> allTags = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo>();
    }

    public class TagAddedEvent : Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.TagAddedEvent:1.0.0", Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagEvent.typeInfo);

    }

    public class TagRemovedEvent : Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.TagRemovedEvent:1.0.0", Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagEvent.typeInfo);
    ...
    public class FirmwareUpdateStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.FirmwareUpdateStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.FirmwareUpdateState state = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.FirmwareUpdateState.UPDATE_STARTED;
    }

    public class BladeOverflowChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.BladeOverflowChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public bool overflow = false;
    }

    public class OrientationChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.OrientationChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class CompositionChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStrip_2_0_5.CompositionChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State _ret_;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.State)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetDeviceInfoResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.DeviceInfo _ret_;
    }
    ...
    public GetDeviceInfoResult getDeviceInfo() {
      ...
      _ret._ret_ = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.DeviceInfo.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetStripInfoResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo _ret_;
    }
    ...
    public GetStripInfoResult getStripInfo() {
      ...
      _ret._ret_ = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.StripInfo.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetRackUnitInfoResult {
      public int _ret_;
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo info;
    }
    ...
    public GetRackUnitInfoResult getRackUnitInfo(int rackUnitNumber) {
      ...
      _ret.info = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo.Decode(_result["info"], agent);
      return _ret;
    }
    ...
    public class GetAllRackUnitInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo> _ret_;
    }
    ...
    public GetAllRackUnitInfosResult getAllRackUnitInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.RackUnitInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetTagResult {
      public int _ret_;
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo tagInfo;
    }
    ...
    public GetTagResult getTag(int rackUnitNumber, int slotNumber) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.tagInfo = Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo.Decode(_result["tagInfo"], agent);
      return _ret;
    }
    ...
    public class GetAllTagsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> _ret_;
    }
    ...
    public GetAllTagsResult getAllTags() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetExtensionTagsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> tags;
    }
    ...
    public GetExtensionTagsResult getExtensionTags(int rackUnitNumber) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.tags = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo>(_result["tags"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public ProgramTagIDsResult programTagIDs(System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> tagInfos) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest programTagIDs(System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> tagInfos, AsyncRpcResponse<ProgramTagIDsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return programTagIDs(tagInfos, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest programTagIDs(System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.TagInfo> tagInfos, AsyncRpcResponse<ProgramTagIDsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["tagInfos"] = new JsonArray(tagInfos.Select(
          _value => (JsonValue)(_value.Encode())));
    ...
    public class GetFirmwareUpdateStateResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.FirmwareUpdateState _ret_;
    }
    ...
    public GetFirmwareUpdateStateResult getFirmwareUpdateState() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.assetmgrmodel.AssetStrip_2_0_5.FirmwareUpdateState)(int)_result["_ret_"];
      return _ret;
    }
