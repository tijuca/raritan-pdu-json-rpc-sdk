...
package Raritan::RPC::security::Security_3_0_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "security.Security:3.0.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::security::Security_3_0_2::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::security::Security_3_0_2::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::security::Security_3_0_2::Settings::encode($settings);
...
sub getSSHHostKeys($) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::security::SSHHostKey::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('security.Security', 3, 0, 2, 'Raritan::RPC::security::Security_3_0_2');
1;
