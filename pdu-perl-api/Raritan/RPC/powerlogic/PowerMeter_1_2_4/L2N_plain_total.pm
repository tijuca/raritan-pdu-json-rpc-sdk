...
package Raritan::RPC::powerlogic::PowerMeter_1_2_4::L2N_plain_total;
...
sub encode {
    ...
    $encoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter_1_2_4::MinMaxReading::encode($in->{'total'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter_1_2_4::MinMaxReading::decode($agent, $in->{'total'});
    return $decoded;
}
