...
package Raritan::RPC::pdumodel::Pdu_4_1_6;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.Pdu:4.1.6";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Pdu_4_1_6::typeId;
...
sub getNameplate($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Nameplate_2_0_0::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_6::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_6::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_6::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Pdu_4_1_6::Settings::encode($settings);
...
sub getStatistic($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_6::Statistic::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getOutletSequenceState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_6::OutletSequenceState::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Pdu', 4, 1, 6, 'Raritan::RPC::pdumodel::Pdu_4_1_6');
1;
