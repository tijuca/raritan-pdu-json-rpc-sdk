...
namespace Com.Raritan.Idl.peripheral {
  public class DeviceManager : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager:1.0.0", null);

    public DeviceManager(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DeviceManager(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DeviceManager StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DeviceManager(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.peripheral.DeviceManager.ZCoordMode)(int)json["zCoordMode"];
        ...
        inst.defaultThresholdsMap = DictionaryHelper.Create(json["defaultThresholdsMap"].AsJsonArray.Select(
          _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_0.Thresholds>(_value["key"], Com.Raritan.Idl.sensors.NumericSensor_3_0_0.Thresholds.Decode(_value["value"], agent))));
        return inst;
      }

      public Com.Raritan.Idl.peripheral.DeviceManager.ZCoordMode zCoordMode = Com.Raritan.Idl.peripheral.DeviceManager.ZCoordMode.RACKUNITS;
      public bool autoManageNewDevices = false;
      public float deviceAltitude = 0.0f;
      public int presenceDetectionTimeout = 0;
      public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_0.Thresholds> defaultThresholdsMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.sensors.NumericSensor_3_0_0.Thresholds>();
    }
    ...
    public class DeviceTypeInfo : ICloneable {
      ...
      public static DeviceTypeInfo Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.defaultRange = Com.Raritan.Idl.sensors.NumericSensor_3_0_0.Range.Decode(json["defaultRange"], agent);
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.peripheral.DeviceManager.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDeviceTypeInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceManager.DeviceTypeInfo> _ret_;
    }
    ...
    public GetDeviceTypeInfosResult getDeviceTypeInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceManager.DeviceTypeInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.DeviceManager.DeviceTypeInfo.Decode(_value, agent)));
      return _ret;
    }
