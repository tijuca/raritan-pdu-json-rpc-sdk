...
namespace Com.Raritan.Idl.sensors {
  public class Logger_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Logger:2.0.0", null);

    public Logger_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Logger_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Logger_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Logger_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.sensors.Logger_2_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Logger_2_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_0_0.Record> recs;
    }
    ...
    public GetSensorRecordsResult getSensorRecords(Com.Raritan.Idl.sensors.Sensor_3_0_0 sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.Record>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.sensors.Logger_2_0_0.Record.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class TimedRecord : ICloneable {
      ...
      public static TimedRecord Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.record = Com.Raritan.Idl.sensors.Logger_2_0_0.Record.Decode(json["record"], agent);
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.sensors.Logger_2_0_0.Record record = new Com.Raritan.Idl.sensors.Logger_2_0_0.Record();
    }

    public class GetSensorTimedRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_0_0.TimedRecord> recs;
    }
    ...
    public GetSensorTimedRecordsResult getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor_3_0_0 sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.TimedRecord>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.sensors.Logger_2_0_0.TimedRecord.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetLoggedSensorsResult {
      public Com.Raritan.Idl.sensors.Logger_2_0_0.SensorSet _ret_;
    }
    ...
    public GetLoggedSensorsResult getLoggedSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Logger_2_0_0.SensorSet.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetLoggedSensorsResult setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_0_0.SensorSet sensors) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_0_0.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setLoggedSensors(sensors, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.sensors.Logger_2_0_0.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensors"] = sensors.Encode();
      } catch (Exception e) {
    ...
    public class LogRow : ICloneable {
      ...
      public static LogRow Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.timestamp = new System.DateTime(json["timestamp"]);
        inst.sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.Record>(json["sensorRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.Logger_2_0_0.Record.Decode(_value, agent)));
        inst.peripheralDeviceRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.Record>(json["peripheralDeviceRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.Logger_2_0_0.Record.Decode(_value, agent)));
        return inst;
      }
      ...
      public System.DateTime timestamp = new System.DateTime(0);
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_0_0.Record> sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.Record>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Logger_2_0_0.Record> peripheralDeviceRecords = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Logger_2_0_0.Record>();
    }

    public class GetLogRowResult {
      public int _ret_;
      public Com.Raritan.Idl.sensors.Logger_2_0_0.LogRow row;
    }
    ...
    public GetLogRowResult getLogRow(int recid) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.row = Com.Raritan.Idl.sensors.Logger_2_0_0.LogRow.Decode(_result["row"], agent);
      return _ret;
    }
