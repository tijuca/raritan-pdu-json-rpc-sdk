...
namespace Com.Raritan.Idl.pdumodel {
  public class Circuit : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Circuit:1.0.0", null);

    public Circuit(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Circuit(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Circuit StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Circuit(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Config : ICloneable {
      ...
      public static Config Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.Circuit.Type)(int)json["type"];
        return inst;
      }

      public int position = 0;
      public Com.Raritan.Idl.pdumodel.Circuit.Type type = Com.Raritan.Idl.pdumodel.Circuit.Type.ONE_PHASE_LN;
    }

    public class GetConfigResult {
      public Com.Raritan.Idl.pdumodel.Circuit.Config _ret_;
    }
    ...
    public GetConfigResult getConfig() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit.Config.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Circuit.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.poleSettings = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Circuit.PoleSettings>(json["poleSettings"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.Circuit.PoleSettings.Decode(_value, agent)));
        return inst;
      }
      ...
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Circuit.PoleSettings> poleSettings = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Circuit.PoleSettings>();
    }

    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Circuit.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Circuit.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Circuit.Settings();
      public Com.Raritan.Idl.pdumodel.Circuit.Settings newSettings = new Com.Raritan.Idl.pdumodel.Circuit.Settings();
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Circuit.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Circuit.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Circuit.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Circuit.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
