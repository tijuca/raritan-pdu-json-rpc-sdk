...
namespace Com.Raritan.Idl.sensors {
  public class Sensor_4_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Sensor:4.0.2", null);
    ...
    public class TypeSpecChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Sensor_4_0_2.TypeSpecChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec oldTypeSpec = new Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec();
      public Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec newTypeSpec = new Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec();
    }

    public class GetTypeSpecResult {
      public Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec _ret_;
    }
    ...
    public GetTypeSpecResult getTypeSpec() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.Sensor_4_0_2.TypeSpec.Decode(_result["_ret_"], agent);
      return _ret;
    }
