...
package Raritan::RPC::sensors::Logger_2_1_5;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "sensors.Logger:2.1.5";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::sensors::Logger_2_1_5::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_1_5::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensorRecords($$$$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_1_5::Record::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getSensorTimedRecords($$$$$) {
    ...
    $$recs = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_1_5::TimedRecord::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getLoggedSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_1_5::SensorSet::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setLoggedSensors($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'sensors'} = Raritan::RPC::sensors::Logger_2_1_5::SensorSet::encode($sensors);
...
sub getLogRow($$$) {
    ...
    $$row = Raritan::RPC::sensors::Logger_2_1_5::LogRow::decode($agent, $rsp->{'row'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}

Raritan::RPC::Registry::registerProxyClass('sensors.Logger', 2, 1, 5, 'Raritan::RPC::sensors::Logger_2_1_5');
1;
