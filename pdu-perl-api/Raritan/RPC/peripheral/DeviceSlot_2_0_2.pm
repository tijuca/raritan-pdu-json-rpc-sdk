...
package Raritan::RPC::peripheral::DeviceSlot_2_0_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "peripheral.DeviceSlot:2.0.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::peripheral::DeviceSlot_2_0_2::typeId;
...
sub assign($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'devid'} = Raritan::RPC::peripheral::DeviceID_3_0_1::encode($devid);
...
sub assignAddress($$$) {
    ...
    $args->{'address'} = Raritan::RPC::peripheral::Address_3_0_1::encode($address);
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceSlot_2_0_2::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::peripheral::DeviceSlot_2_0_2::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('peripheral.DeviceSlot', 2, 0, 2, 'Raritan::RPC::peripheral::DeviceSlot_2_0_2');
1;
