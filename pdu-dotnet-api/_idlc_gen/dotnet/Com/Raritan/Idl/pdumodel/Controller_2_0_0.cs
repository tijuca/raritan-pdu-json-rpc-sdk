...
namespace Com.Raritan.Idl.pdumodel {
  public class Controller_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Controller:2.0.0", null);

    public Controller_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Controller_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Controller_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Controller_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.Controller_2_0_0.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.Controller_2_0_0.Type type = Com.Raritan.Idl.pdumodel.Controller_2_0_0.Type.OUTLET_CTRL;
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Controller_2_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Controller_2_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
