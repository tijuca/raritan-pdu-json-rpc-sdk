...
package Raritan::RPC::pdumodel::Outlet_2_1_5::PowerControlEvent;

use constant typeId => "pdumodel.Outlet_2_1_5.PowerControlEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('pdumodel.Outlet_2_1_5.PowerControlEvent', 1, 0, 0, 'Raritan::RPC::pdumodel::Outlet_2_1_5::PowerControlEvent');
1;
