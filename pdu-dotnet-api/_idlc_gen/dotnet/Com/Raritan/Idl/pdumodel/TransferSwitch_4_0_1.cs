...
namespace Com.Raritan.Idl.pdumodel {
  public class TransferSwitch_4_0_1 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch:4.0.1", null);

    public TransferSwitch_4_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public TransferSwitch_4_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new TransferSwitch_4_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new TransferSwitch_4_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Type type = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Type.STS;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch_4_0_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings oldSettings = new Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings();
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings newSettings = new Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetLastTransferReasonResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferReason _ret_;
    }
    ...
    public GetLastTransferReasonResult getLastTransferReason() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferReason)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetLastTransferWaveformResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample> _ret_;
    }
    ...
    public GetLastTransferWaveformResult getLastTransferWaveform() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class TransferLogEntry : ICloneable {
      ...
      public static TransferLogEntry Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.reason = (Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferReason)(int)json["reason"];
        inst.waveform = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample>(json["waveform"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample.Decode(_value, agent)));
        inst.statistics = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Statistics.Decode(json["statistics"], agent);
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferReason reason = Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferReason.REASON_UNKNOWN;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample> waveform = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.WaveformSample>();
      public Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Statistics statistics = new Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.Statistics();
      public int switchFault = 0;
    }

    public class GetTransferLogResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferLogEntry> _ret_;
    }
    ...
    public GetTransferLogResult getTransferLog() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferLogEntry>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.TransferLogEntry.Decode(_value, agent)));
      return _ret;
    }
