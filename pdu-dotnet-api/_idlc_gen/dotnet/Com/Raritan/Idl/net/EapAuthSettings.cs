...
namespace Com.Raritan.Idl.net {
  ...
  public class EapAuthSettings : ICloneable {
    public object Clone() {
      EapAuthSettings copy = new EapAuthSettings();
    ...
    public static EapAuthSettings Decode(LightJson.JsonObject json, Agent agent) {
      EapAuthSettings inst = new EapAuthSettings();
