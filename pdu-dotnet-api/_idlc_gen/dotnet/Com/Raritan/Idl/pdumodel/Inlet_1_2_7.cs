...
namespace Com.Raritan.Idl.pdumodel {
  public class Inlet_1_2_7 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Inlet:1.2.7", null);

    public Inlet_1_2_7(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Inlet_1_2_7(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Inlet_1_2_7 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Inlet_1_2_7(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.residualCurrent = Com.Raritan.Idl.sensors.NumericSensor_4_0_1.StaticCast(ObjectProxy.Decode(json["residualCurrent"], agent));
        ...
        inst.surgeProtectorStatus = Com.Raritan.Idl.sensors.StateSensor_4_0_1.StaticCast(ObjectProxy.Decode(json["surgeProtectorStatus"], agent));
        inst.residualCurrentStatus = Com.Raritan.Idl.pdumodel.ResidualCurrentStateSensor_2_0_1.StaticCast(ObjectProxy.Decode(json["residualCurrentStatus"], agent));
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_1 residualCurrent = null;
      ...
      public Com.Raritan.Idl.sensors.StateSensor_4_0_1 surgeProtectorStatus = null;
      public Com.Raritan.Idl.pdumodel.ResidualCurrentStateSensor_2_0_1 residualCurrentStatus = null;
    }
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Inlet_1_2_7.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings();
      public Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings newSettings = new Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings();
    }

    public class EnableStateChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Inlet_1_2_7.EnableStateChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool enabled = false;
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_2_7.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_2_7.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetPolesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Pole_3_0_0> _ret_;
    }
    ...
    public GetPolesResult getPoles() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Pole_3_0_0>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_2_7.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
