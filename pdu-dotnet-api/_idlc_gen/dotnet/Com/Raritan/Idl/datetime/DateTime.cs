...
namespace Com.Raritan.Idl.datetime {
  public class DateTime : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("datetime.DateTime:1.0.0", null);

    public DateTime(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DateTime(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DateTime StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DateTime(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class NtpCfg : ICloneable {
      ...
      public LightJson.JsonObject Encode() {
        LightJson.JsonObject json = new LightJson.JsonObject();
        json["forceStatic"] = this.forceStatic;
      ...
      public static NtpCfg Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.forceStatic = (bool)json["forceStatic"];
    ...
    public class Cfg : ICloneable {
      ...
      public static Cfg Decode(LightJson.JsonObject json, Agent agent) {
        Cfg inst = new Cfg();
        inst.zoneCfg = Com.Raritan.Idl.datetime.DateTime.ZoneCfg.Decode(json["zoneCfg"], agent);
        inst.protocol = (Com.Raritan.Idl.datetime.DateTime.Protocol)(int)json["protocol"];
        inst.deviceTime = new System.DateTime(json["deviceTime"]);
        inst.ntpCfg = Com.Raritan.Idl.datetime.DateTime.NtpCfg.Decode(json["ntpCfg"], agent);
        return inst;
      }

      public Com.Raritan.Idl.datetime.DateTime.ZoneCfg zoneCfg = new Com.Raritan.Idl.datetime.DateTime.ZoneCfg();
      public Com.Raritan.Idl.datetime.DateTime.Protocol protocol = Com.Raritan.Idl.datetime.DateTime.Protocol.STATIC;
    ...
    public class GetZoneInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.datetime.DateTime.ZoneInfo> zoneInfos;
    }
    ...
    public GetZoneInfosResult getZoneInfos(bool useOlson) {
      ...
      _ret.zoneInfos = new System.Collections.Generic.List<Com.Raritan.Idl.datetime.DateTime.ZoneInfo>(_result["zoneInfos"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.datetime.DateTime.ZoneInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public TestNtpResult testNtp(Com.Raritan.Idl.datetime.DateTime.NtpCfg ntpCfg) {
      var _parameters = new LightJson.JsonObject();
      _parameters["ntpCfg"] = ntpCfg.Encode();

      var _result = RpcCall("testNtp", _parameters);
      var _ret = new TestNtpResult();
      _ret._ret_ = (bool)_result["_ret_"];
      return _ret;
    }

    public AsyncRequest testNtp(Com.Raritan.Idl.datetime.DateTime.NtpCfg ntpCfg, AsyncRpcResponse<TestNtpResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return testNtp(ntpCfg, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest testNtp(Com.Raritan.Idl.datetime.DateTime.NtpCfg ntpCfg, AsyncRpcResponse<TestNtpResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["ntpCfg"] = ntpCfg.Encode();
      } catch (Exception e) {
      ...
      return RpcCall("testNtp", _parameters,
        _result => {
          try {
            var _ret = new TestNtpResult();
            _ret._ret_ = (bool)_result["_ret_"];
    ...
    public GetCfgResult getCfg() {
      ...
      _ret.cfg = Com.Raritan.Idl.datetime.DateTime.Cfg.Decode(_result["cfg"], agent);
      return _ret;
    }
    ...
    public SetCfgResult setCfg(Com.Raritan.Idl.datetime.DateTime.Cfg cfg) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setCfg(Com.Raritan.Idl.datetime.DateTime.Cfg cfg, AsyncRpcResponse<SetCfgResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setCfg(cfg, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setCfg(Com.Raritan.Idl.datetime.DateTime.Cfg cfg, AsyncRpcResponse<SetCfgResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["cfg"] = cfg.Encode();
      } catch (Exception e) {
    ...
    public GetTimeResult getTime(bool useOlson) {
      ...
      _ret.zone = Com.Raritan.Idl.datetime.DateTime.ZoneInfo.Decode(_result["zone"], agent);
