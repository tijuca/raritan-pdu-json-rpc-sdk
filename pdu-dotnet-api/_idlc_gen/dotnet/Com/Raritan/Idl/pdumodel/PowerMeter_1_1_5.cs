...
namespace Com.Raritan.Idl.pdumodel {
  public class PowerMeter_1_1_5 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter:1.1.5", null);

    public PowerMeter_1_1_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public PowerMeter_1_1_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new PowerMeter_1_1_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new PowerMeter_1_1_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Config : ICloneable {
      ...
      public static Config Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Type)(int)json["type"];
        return inst;
      }

      public int powerMeterId = 0;
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Type type = Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Type.ONE_PHASE;
    }

    public class GetConfigResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Config _ret_;
    }
    ...
    public GetConfigResult getConfig() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Config.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerQuality = Com.Raritan.Idl.sensors.StateSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["powerQuality"], agent));
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.StateSensor_4_0_3 powerQuality = null;
    }

    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetPolesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Pole_5_0_0> _ret_;
    }
    ...
    public GetPolesResult getPoles() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Pole_5_0_0>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter_1_1_5.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings oldSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings();
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings newSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings();
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class EnergyPulseSettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.PowerMeter_1_1_5.EnergyPulseSettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings oldSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings();
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings newSettings = new Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings();
    }

    public class GetEnergyPulseSettingsResult {
      public Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings _ret_;
    }
    ...
    public GetEnergyPulseSettingsResult getEnergyPulseSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetEnergyPulseSettingsResult setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings settings) {
      var _parameters = new LightJson.JsonObject();
      _parameters["settings"] = settings.Encode();
    ...
    public AsyncRequest setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings settings, AsyncRpcResponse<SetEnergyPulseSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setEnergyPulseSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setEnergyPulseSettings(Com.Raritan.Idl.pdumodel.PowerMeter_1_1_5.EnergyPulseSettings settings, AsyncRpcResponse<SetEnergyPulseSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
