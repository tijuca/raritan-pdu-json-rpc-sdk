...
namespace Com.Raritan.Idl.pdumodel {
  public class Outlet_2_1_1 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet:2.1.1", null);

    public Outlet_2_1_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Outlet_2_1_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Outlet_2_1_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Outlet_2_1_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class State : ICloneable {
      ...
      public static State Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerState = (Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState)(int)json["powerState"];
        ...
        inst.ledState = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.LedState.Decode(json["ledState"], agent);
        inst.lastPowerStateChange = new System.DateTime(json["lastPowerStateChange"]);
        return inst;
      }

      public bool available = false;
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState powerState = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState.PS_OFF;
      public bool switchOnInProgress = false;
      public bool cycleInProgress = false;
      public bool isLoadShed = false;
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.LedState ledState = new Com.Raritan.Idl.pdumodel.Outlet_2_1_1.LedState();
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Outlet_2_1_1.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.StartupState startupState = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.StartupState.SS_ON;
    ...
    public class PowerControlEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet_2_1_1.PowerControlEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState state = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState.PS_OFF;
      public bool cycle = false;
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet_2_1_1.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State oldState = new Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State();
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State newState = new Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State();
    }

    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet_2_1_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings();
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings newSettings = new Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State _ret_;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.State.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetPowerStateResult setPowerState(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState pstate) {
    ...
    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setPowerState(pstate, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["pstate"] = (int)pstate;
      } catch (Exception e) {
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet_2_1_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetIOPResult {
      public Com.Raritan.Idl.pdumodel.Inlet_2_0_1 i;
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_1 o;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Pole_4_0_1> p;
    }
    ...
    public GetIOPResult getIOP() {
      ...
      _ret.i = Com.Raritan.Idl.pdumodel.Inlet_2_0_1.StaticCast(ObjectProxy.Decode(_result["i"], agent));
      _ret.o = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_1.StaticCast(ObjectProxy.Decode(_result["o"], agent));
      _ret.p = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Pole_4_0_1>(_result["p"].AsJsonArray.Select(
