...
namespace Com.Raritan.Idl._event {
  public class DataPushService_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("event.DataPushService:1.0.1", null);

    public DataPushService_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DataPushService_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DataPushService_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DataPushService_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class EntrySettings : ICloneable {
      ...
      public static EntrySettings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl._event.DataPushService_1_0_1.EntryType)(int)json["type"];
      ...
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntryType type = Com.Raritan.Idl._event.DataPushService_1_0_1.EntryType.SENSORLIST;
    ...
    public class EntryStatus : ICloneable {
      ...
      public LightJson.JsonObject Encode() {
        ...
        json["lastAttemptTime"] = this.lastAttemptTime.Ticks;
        json["lastSuccessTime"] = this.lastSuccessTime.Ticks;
        return json;
      }
      ...
      public static EntryStatus Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.lastAttemptTime = new System.DateTime(json["lastAttemptTime"]);
        inst.lastSuccessTime = new System.DateTime(json["lastSuccessTime"]);
        return inst;
      }
    ...
    public class EntryAddedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("event.DataPushService_1_0_1.EntryAddedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public int entryId = 0;
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings settings = new Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings();
    }

    public class EntryModifiedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("event.DataPushService_1_0_1.EntryModifiedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public int entryId = 0;
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings oldSettings = new Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings();
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings newSettings = new Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings();
    }

    public class EntryDeletedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("event.DataPushService_1_0_1.EntryDeletedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public int entryId = 0;
    }

    public class EntryStatusChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("event.DataPushService_1_0_1.EntryStatusChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public int entryId = 0;
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntryStatus newStatus = new Com.Raritan.Idl._event.DataPushService_1_0_1.EntryStatus();
    }
    ...
    public AddEntryResult addEntry(Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings) {
    ...
    public AsyncRequest addEntry(Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings, AsyncRpcResponse<AddEntryResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return addEntry(entrySettings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest addEntry(Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings, AsyncRpcResponse<AddEntryResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["entrySettings"] = entrySettings.Encode();
      } catch (Exception e) {
    ...
    public ModifyEntryResult modifyEntry(int entryId, Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest modifyEntry(int entryId, Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings, AsyncRpcResponse<ModifyEntryResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return modifyEntry(entryId, entrySettings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest modifyEntry(int entryId, Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings, AsyncRpcResponse<ModifyEntryResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["entryId"] = entryId;
        _parameters["entrySettings"] = entrySettings.Encode();
    ...
    public class GetEntryResult {
      public int _ret_;
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings entrySettings;
    }
    ...
    public GetEntryResult getEntry(int entryId) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.entrySettings = Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings.Decode(_result["entrySettings"], agent);
      return _ret;
    }
    ...
    public class ListEntriesResult {
      public System.Collections.Generic.IDictionary<int, Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings> _ret_;
    }
    ...
    public ListEntriesResult listEntries() {
      ...
      _ret._ret_ = DictionaryHelper.Create(_result["_ret_"].AsJsonArray.Select(
        _value => new System.Collections.Generic.KeyValuePair<int, Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings>(_value["key"], Com.Raritan.Idl._event.DataPushService_1_0_1.EntrySettings.Decode(_value["value"], agent))));
      return _ret;
    }
    ...
    public class GetEntryStatusResult {
      public int _ret_;
      public Com.Raritan.Idl._event.DataPushService_1_0_1.EntryStatus entryStatus;
    }
    ...
    public GetEntryStatusResult getEntryStatus(int entryId) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.entryStatus = Com.Raritan.Idl._event.DataPushService_1_0_1.EntryStatus.Decode(_result["entryStatus"], agent);
      return _ret;
    }
