...
namespace Com.Raritan.Idl.pdumodel {
  public class Inlet_1_1_2 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Inlet:1.1.2", null);

    public Inlet_1_1_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Inlet_1_1_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Inlet_1_1_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Inlet_1_1_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerQuality = Com.Raritan.Idl.sensors.StateSensor_3_0_0.StaticCast(ObjectProxy.Decode(json["powerQuality"], agent));
        inst.surgeProtectorStatus = Com.Raritan.Idl.sensors.StateSensor_3_0_0.StaticCast(ObjectProxy.Decode(json["surgeProtectorStatus"], agent));
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.StateSensor_3_0_0 powerQuality = null;
      public Com.Raritan.Idl.sensors.StateSensor_3_0_0 surgeProtectorStatus = null;
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_2.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_2.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
