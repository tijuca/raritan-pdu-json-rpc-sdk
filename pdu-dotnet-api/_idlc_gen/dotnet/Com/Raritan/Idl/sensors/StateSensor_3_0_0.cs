...
namespace Com.Raritan.Idl.sensors {
  public class StateSensor_3_0_0 : Com.Raritan.Idl.sensors.Sensor_3_0_0 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.StateSensor:3.0.0", null);

    public StateSensor_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public StateSensor_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new StateSensor_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new StateSensor_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.sensors.StateSensor_3_0_0.State _ret_;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.StateSensor_3_0_0.State.Decode(_result["_ret_"], agent);
      return _ret;
    }
