...
namespace Com.Raritan.Idl.servermon {
  public class ServerMonitor_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("servermon.ServerMonitor:2.0.0", null);

    public ServerMonitor_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public ServerMonitor_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new ServerMonitor_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new ServerMonitor_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class ServerStatus : ICloneable {
      ...
      public static ServerStatus Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.reachable = (Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerReachability)(int)json["reachable"];
      ...
      public Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerReachability reachable = Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerReachability.WAITING;
    ...
    public class Server : ICloneable {
      ...
      public static Server Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.settings = Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings.Decode(json["settings"], agent);
        inst.status = Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerStatus.Decode(json["status"], agent);
        return inst;
      }

      public Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings = new Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings();
      public Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerStatus status = new Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerStatus();
    }
    ...
    public AddServerResult addServer(Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings) {
    ...
    public AsyncRequest addServer(Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings, AsyncRpcResponse<AddServerResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return addServer(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest addServer(Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings, AsyncRpcResponse<AddServerResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public ModifyServerResult modifyServer(int id, Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings) {
      var _parameters = new LightJson.JsonObject();
      _parameters["id"] = id;
      _parameters["settings"] = settings.Encode();
    ...
    public AsyncRequest modifyServer(int id, Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings, AsyncRpcResponse<ModifyServerResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return modifyServer(id, settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest modifyServer(int id, Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.ServerSettings settings, AsyncRpcResponse<ModifyServerResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["id"] = id;
        _parameters["settings"] = settings.Encode();
    ...
    public class GetServerResult {
      public int _ret_;
      public Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.Server server;
    }
    ...
    public GetServerResult getServer(int id) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.server = Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.Server.Decode(_result["server"], agent);
      return _ret;
    }
    ...
    public class ListServersResult {
      public System.Collections.Generic.IDictionary<int, Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.Server> _ret_;
    }
    ...
    public ListServersResult listServers() {
      ...
      _ret._ret_ = DictionaryHelper.Create(_result["_ret_"].AsJsonArray.Select(
        _value => new System.Collections.Generic.KeyValuePair<int, Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.Server>(_value["key"], Com.Raritan.Idl.servermon.ServerMonitor_2_0_0.Server.Decode(_value["value"], agent))));
      return _ret;
    }
