...
package Raritan::RPC::peripheral::DoorHandleControllerPackage_1_0_1;

use parent qw(Raritan::RPC::peripheral::Package_1_0_1);

use constant typeId => "peripheral.DoorHandleControllerPackage:1.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::peripheral::DoorHandleControllerPackage_1_0_1::typeId;
...
Raritan::RPC::Registry::registerProxyClass('peripheral.DoorHandleControllerPackage', 1, 0, 1, 'Raritan::RPC::peripheral::DoorHandleControllerPackage_1_0_1');
1;
