...
namespace Com.Raritan.Idl.webcam {
  public class WebcamManager_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("webcam.WebcamManager:2.0.0", null);

    public WebcamManager_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public WebcamManager_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new WebcamManager_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new WebcamManager_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetWebcamsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.webcam.Webcam_2_0_0> _ret_;
    }
    ...
    public GetWebcamsResult getWebcams() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.webcam.Webcam_2_0_0>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.webcam.Webcam_2_0_0.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetChannelResult {
      public int _ret_;
      public Com.Raritan.Idl.webcam.Channel channel;
    }

    public GetChannelResult getChannel(Com.Raritan.Idl.webcam.Webcam_2_0_0 webcam, string clientType) {
      ...
      _ret.channel = Com.Raritan.Idl.webcam.Channel.StaticCast(ObjectProxy.Decode(_result["channel"], agent));
      return _ret;
    }

    public AsyncRequest getChannel(Com.Raritan.Idl.webcam.Webcam_2_0_0 webcam, string clientType, AsyncRpcResponse<GetChannelResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getChannel(webcam, clientType, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getChannel(Com.Raritan.Idl.webcam.Webcam_2_0_0 webcam, string clientType, AsyncRpcResponse<GetChannelResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["webcam"] = webcam != null ? webcam.Encode() : JsonValue.Null;
        _parameters["clientType"] = clientType;
    ...
    public class GetChannelsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.webcam.Channel> _ret_;
    }
    ...
    public GetChannelsResult getChannels() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.webcam.Channel>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.webcam.Channel.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
