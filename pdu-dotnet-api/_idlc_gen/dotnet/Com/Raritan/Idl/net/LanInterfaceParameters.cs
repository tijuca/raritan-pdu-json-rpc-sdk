...
namespace Com.Raritan.Idl.net {
  ...
  public class LanInterfaceParameters : ICloneable {
    public object Clone() {
      LanInterfaceParameters copy = new LanInterfaceParameters();
    ...
    public static LanInterfaceParameters Decode(LightJson.JsonObject json, Agent agent) {
      LanInterfaceParameters inst = new LanInterfaceParameters();
