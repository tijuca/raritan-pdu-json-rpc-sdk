  ...
  public class Settings_2_0_0 : ICloneable {
    ...
    public static Settings_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      ...
      inst.ethMap = DictionaryHelper.Create(json["ethMap"].AsJsonArray.Select(
        _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.net.EthSettings>(_value["key"], Com.Raritan.Idl.net.EthSettings.Decode(_value["value"], agent))));
      inst.wlanMap = DictionaryHelper.Create(json["wlanMap"].AsJsonArray.Select(
        _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.net.WlanSettings_2_0_0>(_value["key"], Com.Raritan.Idl.net.WlanSettings_2_0_0.Decode(_value["value"], agent))));
      return inst;
    }
    ...
    public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.net.EthSettings> ethMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.net.EthSettings>();
    public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.net.WlanSettings_2_0_0> wlanMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.net.WlanSettings_2_0_0>();
  }
}
