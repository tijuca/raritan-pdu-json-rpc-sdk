...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class DoublePole_4_0_0 : ICloneable {
    public object Clone() {
      DoublePole_4_0_0 copy = new DoublePole_4_0_0();
    ...
    public static DoublePole_4_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      DoublePole_4_0_0 inst = new DoublePole_4_0_0();
