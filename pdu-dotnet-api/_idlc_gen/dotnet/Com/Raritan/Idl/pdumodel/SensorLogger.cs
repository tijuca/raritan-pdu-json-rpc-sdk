...
namespace Com.Raritan.Idl.pdumodel {
  public class SensorLogger : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.SensorLogger:1.0.0", null);

    public SensorLogger(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public SensorLogger(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new SensorLogger StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new SensorLogger(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.SensorLogger.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.SensorLogger.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class Record : ICloneable {
      ...
      public static Record Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.state = (Com.Raritan.Idl.pdumodel.SensorLogger.SensorState)(int)json["state"];
      ...
      public Com.Raritan.Idl.pdumodel.SensorLogger.SensorState state = Com.Raritan.Idl.pdumodel.SensorLogger.SensorState.UNAVAILABLE;
    ...
    public class GetSensorRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger.Record> recs;
    }
    ...
    public GetSensorRecordsResult getSensorRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger.Record>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.SensorLogger.Record.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class TimedRecord : ICloneable {
      ...
      public static TimedRecord Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.record = Com.Raritan.Idl.pdumodel.SensorLogger.Record.Decode(json["record"], agent);
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.pdumodel.SensorLogger.Record record = new Com.Raritan.Idl.pdumodel.SensorLogger.Record();
    }

    public class GetSensorTimedRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger.TimedRecord> recs;
    }
    ...
    public GetSensorTimedRecordsResult getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger.TimedRecord>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.SensorLogger.TimedRecord.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetLoggedSensorsResult {
      public Com.Raritan.Idl.pdumodel.SensorLogger.SensorSet _ret_;
    }
    ...
    public GetLoggedSensorsResult getLoggedSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.SensorLogger.SensorSet.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetLoggedSensorsResult setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger.SensorSet sensors) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setLoggedSensors(sensors, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensors"] = sensors.Encode();
      } catch (Exception e) {
