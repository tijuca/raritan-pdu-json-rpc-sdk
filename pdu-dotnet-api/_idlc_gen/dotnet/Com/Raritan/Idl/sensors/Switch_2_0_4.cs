...
namespace Com.Raritan.Idl.sensors {
  public class Switch_2_0_4 : Com.Raritan.Idl.sensors.StateSensor_4_0_2 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Switch:2.0.4", null);

    public Switch_2_0_4(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Switch_2_0_4(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Switch_2_0_4 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Switch_2_0_4(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class SwitchEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Switch_2_0_4.SwitchEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);
