...
package Raritan::RPC::pdumodel::Outlet_2_1_3;

use parent qw(Raritan::RPC::pdumodel::EDevice);

use constant typeId => "pdumodel.Outlet:2.1.3";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Outlet_2_1_3::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_3::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_3::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_3::State::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_3::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Outlet_2_1_3::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Outlet', 2, 1, 3, 'Raritan::RPC::pdumodel::Outlet_2_1_3');
1;
