...
namespace Com.Raritan.Idl.radius {
  ...
  public class ServerSettings_2_0_0 : ICloneable {
    ...
    public static ServerSettings_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      ...
      inst.authType = (Com.Raritan.Idl.radius.AuthType_2_0_0)(int)json["authType"];
      return inst;
    }
    ...
    public Com.Raritan.Idl.radius.AuthType_2_0_0 authType = Com.Raritan.Idl.radius.AuthType_2_0_0.PAP;
  }
}
