...
namespace Com.Raritan.Idl.pdumodel {
  public class Outlet : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet:1.0.0", null);

    public Outlet(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Outlet(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Outlet StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Outlet(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class State : ICloneable {
      ...
      public static State Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerState = (Com.Raritan.Idl.pdumodel.Outlet.PowerState)(int)json["powerState"];
        inst.switchOnInProgress = (bool)json["switchOnInProgress"];
        inst.cycleInProgress = (bool)json["cycleInProgress"];
        inst.ledState = Com.Raritan.Idl.pdumodel.Outlet.LedState.Decode(json["ledState"], agent);
        inst.lastPowerStateChange = new System.DateTime(json["lastPowerStateChange"]);
        return inst;
      }

      public bool available = false;
      public Com.Raritan.Idl.pdumodel.Outlet.PowerState powerState = Com.Raritan.Idl.pdumodel.Outlet.PowerState.PS_OFF;
      public bool switchOnInProgress = false;
      public bool cycleInProgress = false;
      public Com.Raritan.Idl.pdumodel.Outlet.LedState ledState = new Com.Raritan.Idl.pdumodel.Outlet.LedState();
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Outlet.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Outlet.StartupState startupState = Com.Raritan.Idl.pdumodel.Outlet.StartupState.SS_ON;
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Outlet.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Outlet.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.pdumodel.Outlet.State _ret_;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet.State.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetPowerStateResult setPowerState(Com.Raritan.Idl.pdumodel.Outlet.PowerState pstate) {
    ...
    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setPowerState(pstate, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["pstate"] = (int)pstate;
      } catch (Exception e) {
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Outlet.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Outlet.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetControllerResult {
      public Com.Raritan.Idl.pdumodel.Controller _ret_;
    }
    ...
    public GetControllerResult getController() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Controller.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
