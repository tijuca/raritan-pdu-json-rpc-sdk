...
namespace Com.Raritan.Idl.serial {
  public class GsmModem : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("serial.GsmModem:1.0.0", null);

    public GsmModem(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public GsmModem(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new GsmModem StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new GsmModem(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.serial.GsmModem.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.serial.GsmModem.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.serial.GsmModem.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.serial.GsmModem.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public SendTestSmsResult sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem.Settings testSettings) {
      var _parameters = new LightJson.JsonObject();
      _parameters["recipient"] = recipient;
    ...
    public AsyncRequest sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem.Settings testSettings, AsyncRpcResponse<SendTestSmsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return sendTestSms(recipient, testSettings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem.Settings testSettings, AsyncRpcResponse<SendTestSmsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["recipient"] = recipient;
        _parameters["testSettings"] = testSettings.Encode();
    ...
    public GetInformationResult getInformation() {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.info = Com.Raritan.Idl.serial.GsmModem.Information.Decode(_result["info"], agent);
      return _ret;
    }
