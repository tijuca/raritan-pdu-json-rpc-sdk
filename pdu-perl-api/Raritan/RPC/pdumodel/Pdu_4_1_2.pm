...
package Raritan::RPC::pdumodel::Pdu_4_1_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.Pdu:4.1.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Pdu_4_1_2::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_2::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_2::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_2::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Pdu_4_1_2::Settings::encode($settings);
...
sub getStatistic($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_2::Statistic::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getOutletSequenceState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_4_1_2::OutletSequenceState::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Pdu', 4, 1, 2, 'Raritan::RPC::pdumodel::Pdu_4_1_2');
1;
