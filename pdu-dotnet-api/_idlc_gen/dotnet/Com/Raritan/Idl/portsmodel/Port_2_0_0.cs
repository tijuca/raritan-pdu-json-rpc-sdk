...
namespace Com.Raritan.Idl.portsmodel {
  public class Port_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("portsmodel.Port:2.0.0", null);

    public Port_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Port_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Port_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Port_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class DetectionMode : ICloneable {
      ...
      public static DetectionMode Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionType)(int)json["type"];
        inst.pinnedDeviceType = (string)json["pinnedDeviceType"];
        return inst;
      }

      public Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionType type = Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionType.AUTO;
    ...
    public class Properties : ICloneable {
      ...
      public static Properties Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.mode = Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode.Decode(json["mode"], agent);
      ...
      public string name = "";
      public string label = "";
      public Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode mode = new Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode();
      public string detectedDeviceType = "";
      public string detectedDeviceName = "";
    }

    public class GetPropertiesResult {
      public Com.Raritan.Idl.portsmodel.Port_2_0_0.Properties _ret_;
    }
    ...
    public GetPropertiesResult getProperties() {
      ...
      _ret._ret_ = Com.Raritan.Idl.portsmodel.Port_2_0_0.Properties.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetDetectionModeResult setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode mode) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode mode, AsyncRpcResponse<SetDetectionModeResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setDetectionMode(mode, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setDetectionMode(Com.Raritan.Idl.portsmodel.Port_2_0_0.DetectionMode mode, AsyncRpcResponse<SetDetectionModeResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["mode"] = mode.Encode();
      } catch (Exception e) {
