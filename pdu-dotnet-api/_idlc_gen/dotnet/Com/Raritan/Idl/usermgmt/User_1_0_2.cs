...
namespace Com.Raritan.Idl.usermgmt {
  public class User_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("usermgmt.User:1.0.2", null);

    public User_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public User_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new User_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new User_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public const int ERR_WRONG_PASSWORD = 13;
