...
namespace Com.Raritan.Idl.assetmgrmodel {
  public class AssetStripLogger : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("assetmgrmodel.AssetStripLogger:1.0.0", null);

    public AssetStripLogger(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public AssetStripLogger(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new AssetStripLogger StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new AssetStripLogger(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Record : ICloneable {
      ...
      public static Record Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.RecordType)(int)json["type"];
      ...
      public Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.RecordType type = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.RecordType.EMPTY;
    ...
    public class GetInfoResult {
      public Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.Info _ret_;
    }
    ...
    public GetInfoResult getInfo() {
      ...
      _ret._ret_ = Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.Info.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.Record> records;
    }
    ...
    public GetRecordsResult getRecords(int id, int count) {
      ...
      _ret.records = new System.Collections.Generic.List<Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.Record>(_result["records"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.assetmgrmodel.AssetStripLogger.Record.Decode(_value, agent)));
      return _ret;
    }
