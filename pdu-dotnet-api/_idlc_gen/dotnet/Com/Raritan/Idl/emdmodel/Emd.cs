...
namespace Com.Raritan.Idl.emdmodel {
  public class Emd : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("emdmodel.Emd:1.0.0", null);

    public Emd(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Emd(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Emd StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Emd(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.emdmodel.Emd.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.emdmodel.Emd.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.emdmodel.Emd.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
