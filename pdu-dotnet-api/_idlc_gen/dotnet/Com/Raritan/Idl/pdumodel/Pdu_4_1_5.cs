...
namespace Com.Raritan.Idl.pdumodel {
  public class Pdu_4_1_5 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu:4.1.5", null);

    public Pdu_4_1_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Pdu_4_1_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Pdu_4_1_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Pdu_4_1_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Statistic : ICloneable {
      ...
      public static Statistic Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.peripheralStats = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Statistics.Decode(json["peripheralStats"], agent);
        return inst;
      }
      ...
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Statistics peripheralStats = new Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Statistics();
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Pdu_4_1_5.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.StartupState startupState = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.StartupState.SS_ON;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_5.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings();
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings newSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings();
    }

    public class LoadSheddingModeChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_5.LoadSheddingModeChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool enabled = false;
    }

    public class OutletSequenceStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_5.OutletSequenceStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.OutletSequenceState newState = new Com.Raritan.Idl.pdumodel.Pdu_4_1_5.OutletSequenceState();
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Outlet_2_1_4> _ret_;
    }
    ...
    public GetOutletsResult getOutlets() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Outlet_2_1_4>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetOverCurrentProtectorsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_3> _ret_;
    }
    ...
    public GetOverCurrentProtectorsResult getOverCurrentProtectors() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_3>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_3.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetInletsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Inlet_2_0_3> _ret_;
    }
    ...
    public GetInletsResult getInlets() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Inlet_2_0_3>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.Inlet_2_0_3.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetTransferSwitchesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_3> _ret_;
    }
    ...
    public GetTransferSwitchesResult getTransferSwitches() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_3>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_3.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetPeripheralDeviceManagerResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1 _ret_;
    }
    ...
    public GetPeripheralDeviceManagerResult getPeripheralDeviceManager() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public SetMultipleOutletPowerStatesResult setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_4.PowerState state, bool respectSequence) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_4.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setMultipleOutletPowerStates(outletNumbers, state, respectSequence, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_4.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["outletNumbers"] = new JsonArray(outletNumbers.Select(
          _value => (JsonValue)(_value)));
    ...
    public class GetStatisticResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Statistic _ret_;
    }
    ...
    public GetStatisticResult getStatistic() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.Statistic.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletSequenceStateResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_5.OutletSequenceState _ret_;
    }
    ...
    public GetOutletSequenceStateResult getOutletSequenceState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_5.OutletSequenceState.Decode(_result["_ret_"], agent);
      return _ret;
    }
