...
namespace Com.Raritan.Idl.firmware {
  public class Firmware_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("firmware.Firmware:1.0.1", null);

    public Firmware_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Firmware_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Firmware_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Firmware_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
