...
namespace Com.Raritan.Idl.pdumodel {
  public class MemoryMapController_3_0_0 : Com.Raritan.Idl.pdumodel.Controller_3_0_0 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.MemoryMapController:3.0.0", null);

    public MemoryMapController_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public MemoryMapController_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new MemoryMapController_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new MemoryMapController_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
