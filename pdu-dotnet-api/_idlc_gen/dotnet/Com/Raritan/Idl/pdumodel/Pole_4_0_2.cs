...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class Pole_4_0_2 : ICloneable {
    public object Clone() {
      Pole_4_0_2 copy = new Pole_4_0_2();
    ...
    public static Pole_4_0_2 Decode(LightJson.JsonObject json, Agent agent) {
      Pole_4_0_2 inst = new Pole_4_0_2();
      ...
      inst.voltageLN = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.StaticCast(ObjectProxy.Decode(json["voltageLN"], agent));
    ...
    public Com.Raritan.Idl.sensors.NumericSensor_4_0_2 voltageLN = null;
