...
namespace Com.Raritan.Idl.net {
  public class Net_2_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("net.Net:2.0.1", null);

    public Net_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Net_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Net_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Net_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
