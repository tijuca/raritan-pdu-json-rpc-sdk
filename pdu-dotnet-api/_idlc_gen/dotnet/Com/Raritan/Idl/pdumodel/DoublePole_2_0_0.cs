...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class DoublePole_2_0_0 : ICloneable {
    public object Clone() {
      DoublePole_2_0_0 copy = new DoublePole_2_0_0();
    ...
    public static DoublePole_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      DoublePole_2_0_0 inst = new DoublePole_2_0_0();
      ...
      inst.voltageLN = Com.Raritan.Idl.sensors.NumericSensor_4_0_0.StaticCast(ObjectProxy.Decode(json["voltageLN"], agent));
    ...
    public Com.Raritan.Idl.sensors.NumericSensor_4_0_0 voltageLN = null;
