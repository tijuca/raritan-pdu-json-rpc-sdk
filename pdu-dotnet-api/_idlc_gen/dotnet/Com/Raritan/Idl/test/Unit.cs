...
namespace Com.Raritan.Idl.test {
  public class Unit : ObjectProxy {
    ...
    static public readonly new TypeInfo typeInfo = new TypeInfo("test.Unit:1.0.0", null);
    ...
    public class GetDisplaysResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.test.Display> _ret_;
    }
    ...
    public GetDisplaysResult getDisplays() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.test.Display>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.test.Display.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
