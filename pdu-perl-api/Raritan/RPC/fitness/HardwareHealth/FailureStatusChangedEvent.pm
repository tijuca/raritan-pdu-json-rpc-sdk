...
package Raritan::RPC::fitness::HardwareHealth::FailureStatusChangedEvent;

use constant typeId => "fitness.HardwareHealth.FailureStatusChangedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('fitness.HardwareHealth.FailureStatusChangedEvent', 1, 0, 0, 'Raritan::RPC::fitness::HardwareHealth::FailureStatusChangedEvent');
1;
