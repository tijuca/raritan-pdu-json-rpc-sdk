...
namespace Com.Raritan.Idl._event {
  public class Service_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("event.Service:1.0.1", null);

    public Service_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Service_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Service_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Service_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }

    public const int INVALID_CHANNEL = 1;

    public class CreateChannelResult {
      public Com.Raritan.Idl._event.Channel_1_0_1 _ret_;
    }
    ...
    public CreateChannelResult createChannel() {
      ...
      _ret._ret_ = Com.Raritan.Idl._event.Channel_1_0_1.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public DestroyChannelResult destroyChannel(Com.Raritan.Idl._event.Channel_1_0_1 channel) {
    ...
    public AsyncRequest destroyChannel(Com.Raritan.Idl._event.Channel_1_0_1 channel, AsyncRpcResponse<DestroyChannelResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return destroyChannel(channel, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest destroyChannel(Com.Raritan.Idl._event.Channel_1_0_1 channel, AsyncRpcResponse<DestroyChannelResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["channel"] = channel != null ? channel.Encode() : JsonValue.Null;
      } catch (Exception e) {
