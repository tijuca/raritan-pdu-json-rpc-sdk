...
namespace Com.Raritan.JsonRpc.sensors.AccumulatingNumericSensor_2_0_1 {
  public class ResetEvent_ValObjCodec : Com.Raritan.JsonRpc._event.UserEvent_ValObjCodec {

    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.sensors.AccumulatingNumericSensor_2_0_1.ResetEvent.typeInfo, new ResetEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.sensors.AccumulatingNumericSensor_2_0_1.ResetEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.sensors.AccumulatingNumericSensor_2_0_1.ResetEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.sensors.AccumulatingNumericSensor_2_0_1.ResetEvent();
      } else {
        inst = (Com.Raritan.Idl.sensors.AccumulatingNumericSensor_2_0_1.ResetEvent)vo;
      }
