...
namespace Com.Raritan.Idl.pdumodel {
  public class Inlet_1_1_5 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Inlet:1.1.5", null);

    public Inlet_1_1_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Inlet_1_1_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Inlet_1_1_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Inlet_1_1_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }

    public enum Events {
      EVT_KEY_SETTINGS_CHANGED,
      EVT_KEY_ENABLE_STATE_CHANGED,
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.residualCurrent = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["residualCurrent"], agent));
        ...
        inst.powerQuality = Com.Raritan.Idl.sensors.StateSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["powerQuality"], agent));
        inst.surgeProtectorStatus = Com.Raritan.Idl.sensors.StateSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["surgeProtectorStatus"], agent));
        inst.residualCurrentStatus = Com.Raritan.Idl.pdumodel.ResidualCurrentStateSensor.StaticCast(ObjectProxy.Decode(json["residualCurrentStatus"], agent));
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1 residualCurrent = null;
      ...
      public Com.Raritan.Idl.sensors.StateSensor_3_0_1 powerQuality = null;
      public Com.Raritan.Idl.sensors.StateSensor_3_0_1 surgeProtectorStatus = null;
      public Com.Raritan.Idl.pdumodel.ResidualCurrentStateSensor residualCurrentStatus = null;
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_5.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_5.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetPolesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Pole_1_1_1> _ret_;
    }
    ...
    public GetPolesResult getPoles() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Pole_1_1_1>(_result["_ret_"].AsJsonArray.Select(
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Inlet_1_1_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
