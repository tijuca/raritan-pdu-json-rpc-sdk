...
namespace Com.Raritan.Idl.sensors {
  public class NumericSensor_4_0_2 : Com.Raritan.Idl.sensors.Sensor_4_0_2 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor:4.0.2", null);

    public NumericSensor_4_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public NumericSensor_4_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new NumericSensor_4_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new NumericSensor_4_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.range = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Range.Decode(json["range"], agent);
        inst.thresholdCaps = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.ThresholdCapabilities.Decode(json["thresholdCaps"], agent);
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Range range = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Range();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.ThresholdCapabilities thresholdCaps = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.ThresholdCapabilities();
    }
    ...
    public class Reading : ICloneable {
      ...
      public static Reading Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.status = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading.Status.Decode(json["status"], agent);
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading.Status status = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading.Status();
      public bool valid = false;
      public double value = 0.0;
    }

    public class ReadingChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_2.ReadingChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading newReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading();
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_2.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading oldReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading newReading = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading();
    }

    public class MetaDataChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_2.MetaDataChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData oldMetaData = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData newMetaData = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData();
    }

    public class ThresholdsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor_4_0_2.ThresholdsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds oldThresholds = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds newThresholds = new Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDefaultThresholdsResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds _ret_;
    }
    ...
    public GetDefaultThresholdsResult getDefaultThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds thresh) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresh, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresh"] = thresh.Encode();
      } catch (Exception e) {
    ...
    public class GetReadingResult {
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading _ret_;
    }
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_4_0_2.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
