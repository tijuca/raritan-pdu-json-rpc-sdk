...
namespace Com.Raritan.Idl.bulkcfg {
  public class BulkConfiguration_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("bulkcfg.BulkConfiguration:1.0.2", null);

    public BulkConfiguration_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public BulkConfiguration_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new BulkConfiguration_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new BulkConfiguration_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public GetStatusResult getStatus() {
      ...
      _ret.status = (Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Status)(int)_result["status"];
    ...
    public class FilterProfile : ICloneable {
      ...
      public static FilterProfile Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.filterNameToTypeMap = DictionaryHelper.Create(json["filterNameToTypeMap"].AsJsonArray.Select(
          _value => new System.Collections.Generic.KeyValuePair<string, Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterType>(_value["key"], (Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterType)(int)_value["value"])));
        return inst;
      }

      public string name = "";
      public string description = "";
      public System.Collections.Generic.IDictionary<string, Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterType> filterNameToTypeMap = new System.Collections.Generic.Dictionary<string, Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterType>();
    }

    public class Settings : ICloneable {
      public object Clone() {
        Settings copy = new Settings();
        copy.filterProfiles = this.filterProfiles;
      ...
      public LightJson.JsonObject Encode() {
        LightJson.JsonObject json = new LightJson.JsonObject();
        json["filterProfiles"] = new JsonArray(this.filterProfiles.Select(
          _value => (JsonValue)(_value.Encode())));
        json["defaultProfileName"] = this.defaultProfileName;
        return json;
      }

      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        Settings inst = new Settings();
        inst.filterProfiles = new System.Collections.Generic.List<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile>(json["filterProfiles"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile.Decode(_value, agent)));
        inst.defaultProfileName = (string)json["defaultProfileName"];
        return inst;
      }

      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile> filterProfiles = new System.Collections.Generic.List<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile>();
      public string defaultProfileName = "";
    }

    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("bulkcfg.BulkConfiguration_1_0_2.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

    }

    public class SavedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("bulkcfg.BulkConfiguration_1_0_2.SavedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool isBackup = false;
    }

    public class RestoredEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("bulkcfg.BulkConfiguration_1_0_2.RestoredEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);
    ...
    public class GetFiltersResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Filter> _ret_;
    }
    ...
    public GetFiltersResult getFilters() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Filter>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Filter.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetFilterProfilesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile> _ret_;
    }
    ...
    public GetFilterProfilesResult getFilterProfiles() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile.Decode(_value, agent)));
      return _ret;
    }
    ...
    public AddFilterProfileResult addFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile) {
    ...
    public AsyncRequest addFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile, AsyncRpcResponse<AddFilterProfileResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return addFilterProfile(profile, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest addFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile, AsyncRpcResponse<AddFilterProfileResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["profile"] = profile.Encode();
      } catch (Exception e) {
    ...
    public ModifyFilterProfileResult modifyFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile) {
      var _parameters = new LightJson.JsonObject();
      _parameters["profile"] = profile.Encode();
    ...
    public AsyncRequest modifyFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile, AsyncRpcResponse<ModifyFilterProfileResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return modifyFilterProfile(profile, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest modifyFilterProfile(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.FilterProfile profile, AsyncRpcResponse<ModifyFilterProfileResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["profile"] = profile.Encode();
      } catch (Exception e) {
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.bulkcfg.BulkConfiguration_1_0_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
