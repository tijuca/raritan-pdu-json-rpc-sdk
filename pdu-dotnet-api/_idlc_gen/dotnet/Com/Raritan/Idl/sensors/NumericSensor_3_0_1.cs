...
namespace Com.Raritan.Idl.sensors {
  public class NumericSensor_3_0_1 : Com.Raritan.Idl.sensors.Sensor_3_0_0 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.NumericSensor:3.0.1", null);

    public NumericSensor_3_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public NumericSensor_3_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new NumericSensor_3_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new NumericSensor_3_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.range = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range.Decode(json["range"], agent);
        inst.thresholdCaps = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.ThresholdCapabilities.Decode(json["thresholdCaps"], agent);
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range range = new Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Range();
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.ThresholdCapabilities thresholdCaps = new Com.Raritan.Idl.sensors.NumericSensor_3_0_1.ThresholdCapabilities();
    }
    ...
    public class Reading : ICloneable {
      ...
      public static Reading Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.status = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Reading.Status.Decode(json["status"], agent);
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Reading.Status status = new Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Reading.Status();
      public bool valid = false;
      public double value = 0.0;
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDefaultThresholdsResult {
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds _ret_;
    }
    ...
    public GetDefaultThresholdsResult getDefaultThresholds() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetThresholdsResult setThresholds(Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds thresh) {
    ...
    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setThresholds(thresh, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setThresholds(Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Thresholds thresh, AsyncRpcResponse<SetThresholdsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["thresh"] = thresh.Encode();
      } catch (Exception e) {
    ...
    public class GetReadingResult {
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Reading _ret_;
    }
    ...
    public GetReadingResult getReading() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.Reading.Decode(_result["_ret_"], agent);
      return _ret;
    }
