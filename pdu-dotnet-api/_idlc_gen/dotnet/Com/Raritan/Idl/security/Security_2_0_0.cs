...
namespace Com.Raritan.Idl.security {
  public class Security_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("security.Security:2.0.0", null);

    public Security_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Security_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Security_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Security_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.security.Security_2_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.security.Security_2_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.security.Security_2_0_0.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.security.Security_2_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.security.Security_2_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
