...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class DoublePole : ICloneable {
    public object Clone() {
      DoublePole copy = new DoublePole();
    ...
    public static DoublePole Decode(LightJson.JsonObject json, Agent agent) {
      DoublePole inst = new DoublePole();
