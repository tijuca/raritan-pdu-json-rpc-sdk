...
package Raritan::RPC::pdumodel::Controller_4_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.Controller:4.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Controller_4_0_1::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Controller_4_0_1::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Controller', 4, 0, 1, 'Raritan::RPC::pdumodel::Controller_4_0_1');
1;
