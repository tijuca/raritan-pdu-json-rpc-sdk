...
namespace Com.Raritan.Idl.sensors {
  public class AccumulatingNumericSensor : Com.Raritan.Idl.sensors.NumericSensor_3_0_1 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.AccumulatingNumericSensor:1.0.0", null);

    public AccumulatingNumericSensor(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public AccumulatingNumericSensor(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new AccumulatingNumericSensor StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new AccumulatingNumericSensor(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
