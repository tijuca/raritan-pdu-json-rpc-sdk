...
namespace Com.Raritan.Idl.logging {
  public class DebugLog_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("logging.DebugLog:2.0.0", null);

    public DebugLog_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DebugLog_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DebugLog_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DebugLog_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
