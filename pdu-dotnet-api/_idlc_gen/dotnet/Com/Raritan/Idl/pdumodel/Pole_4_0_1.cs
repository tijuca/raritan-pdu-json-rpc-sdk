...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class Pole_4_0_1 : ICloneable {
    public object Clone() {
      Pole_4_0_1 copy = new Pole_4_0_1();
    ...
    public static Pole_4_0_1 Decode(LightJson.JsonObject json, Agent agent) {
      Pole_4_0_1 inst = new Pole_4_0_1();
