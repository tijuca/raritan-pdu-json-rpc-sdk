...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class Pole_1_1_1 : ICloneable {
    public object Clone() {
      Pole_1_1_1 copy = new Pole_1_1_1();
    ...
    public static Pole_1_1_1 Decode(LightJson.JsonObject json, Agent agent) {
      Pole_1_1_1 inst = new Pole_1_1_1();
