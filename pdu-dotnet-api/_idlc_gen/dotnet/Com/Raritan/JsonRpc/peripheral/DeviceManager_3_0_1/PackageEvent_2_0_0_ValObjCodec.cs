...
namespace Com.Raritan.JsonRpc.peripheral.DeviceManager_3_0_1 {
  public class PackageEvent_2_0_0_ValObjCodec : Com.Raritan.JsonRpc.idl.Event_ValObjCodec {
    ...
    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0.typeInfo, new PackageEvent_2_0_0_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0 inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0();
      } else {
        inst = (Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0)vo;
      }
