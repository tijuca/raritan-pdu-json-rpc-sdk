...
namespace Com.Raritan.JsonRpc.pdumodel.PowerMeterController_1_1_2 {
  public class PowerMeterDeletedEvent_ValObjCodec : Com.Raritan.JsonRpc._event.UserEvent_ValObjCodec {
    ...
    public static new void Register() {
      ValueObjectCodec.RegisterCodec(Com.Raritan.Idl.pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent.typeInfo, new PowerMeterDeletedEvent_ValObjCodec());
    }

    public override void EncodeValObj(LightJson.JsonObject json, ValueObject vo) {
      base.EncodeValObj(json, vo);
      var inst = (Com.Raritan.Idl.pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent)vo;
    ...
    public override ValueObject DecodeValObj(ValueObject vo, LightJson.JsonObject json, Agent agent) {
      Com.Raritan.Idl.pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent inst;
      if (vo == null) {
        inst = new Com.Raritan.Idl.pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent();
      } else {
        inst = (Com.Raritan.Idl.pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent)vo;
      }
