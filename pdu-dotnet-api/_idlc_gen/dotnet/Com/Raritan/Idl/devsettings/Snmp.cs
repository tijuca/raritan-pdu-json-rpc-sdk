...
namespace Com.Raritan.Idl.devsettings {
  public class Snmp : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("devsettings.Snmp:1.0.0", null);

    public Snmp(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Snmp(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Snmp StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Snmp(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetConfigurationResult {
      public Com.Raritan.Idl.devsettings.Snmp.Configuration _ret_;
    }
    ...
    public GetConfigurationResult getConfiguration() {
      ...
      _ret._ret_ = Com.Raritan.Idl.devsettings.Snmp.Configuration.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetConfigurationResult setConfiguration(Com.Raritan.Idl.devsettings.Snmp.Configuration cfg) {
    ...
    public AsyncRequest setConfiguration(Com.Raritan.Idl.devsettings.Snmp.Configuration cfg, AsyncRpcResponse<SetConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setConfiguration(cfg, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setConfiguration(Com.Raritan.Idl.devsettings.Snmp.Configuration cfg, AsyncRpcResponse<SetConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["cfg"] = cfg.Encode();
      } catch (Exception e) {
