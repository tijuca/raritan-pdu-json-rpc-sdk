...
namespace Com.Raritan.Idl.pdumodel {
  public class Pdu_4_1_3 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu:4.1.3", null);

    public Pdu_4_1_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Pdu_4_1_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Pdu_4_1_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Pdu_4_1_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Pdu_4_1_3.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.StartupState startupState = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.StartupState.SS_ON;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_3.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings();
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings newSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings();
    }

    public class LoadSheddingModeChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_3.LoadSheddingModeChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool enabled = false;
    }

    public class OutletSequenceStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_1_3.OutletSequenceStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.OutletSequenceState newState = new Com.Raritan.Idl.pdumodel.Pdu_4_1_3.OutletSequenceState();
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Outlet_2_1_2> _ret_;
    }
    ...
    public GetOutletsResult getOutlets() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Outlet_2_1_2>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.Outlet_2_1_2.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public SetAllOutletPowerStatesResult setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState pstate) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState pstate, AsyncRpcResponse<SetAllOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setAllOutletPowerStates(pstate, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setAllOutletPowerStates(Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState pstate, AsyncRpcResponse<SetAllOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["pstate"] = (int)pstate;
      } catch (Exception e) {
    ...
    public SetMultipleOutletPowerStatesResult setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState state, bool respectSequence) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setMultipleOutletPowerStates(outletNumbers, state, respectSequence, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setMultipleOutletPowerStates(System.Collections.Generic.IEnumerable<int> outletNumbers, Com.Raritan.Idl.pdumodel.Outlet_2_1_2.PowerState state, bool respectSequence, AsyncRpcResponse<SetMultipleOutletPowerStatesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["outletNumbers"] = new JsonArray(outletNumbers.Select(
          _value => (JsonValue)(_value)));
    ...
    public class GetStatisticResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Statistic _ret_;
    }
    ...
    public GetStatisticResult getStatistic() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.Statistic.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletSequenceStateResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_1_3.OutletSequenceState _ret_;
    }
    ...
    public GetOutletSequenceStateResult getOutletSequenceState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_1_3.OutletSequenceState.Decode(_result["_ret_"], agent);
      return _ret;
    }
