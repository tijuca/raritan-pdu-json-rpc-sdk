...
package Raritan::RPC::emdmodel::Emd_2_2_8;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "emdmodel.Emd:2.2.8";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::emdmodel::Emd_2_2_8::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::emdmodel::Emd_2_2_8::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::emdmodel::Emd_2_2_8::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::emdmodel::Emd_2_2_8::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('emdmodel.Emd', 2, 2, 8, 'Raritan::RPC::emdmodel::Emd_2_2_8');
1;
