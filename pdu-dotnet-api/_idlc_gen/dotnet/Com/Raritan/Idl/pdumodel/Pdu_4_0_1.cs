...
namespace Com.Raritan.Idl.pdumodel {
  public class Pdu_4_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu:4.0.1", null);

    public Pdu_4_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Pdu_4_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Pdu_4_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Pdu_4_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Pdu_4_0_1.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.StartupState startupState = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.StartupState.SS_ON;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_0_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings();
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings newSettings = new Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings();
    }

    public class LoadSheddingModeChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_0_1.LoadSheddingModeChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool enabled = false;
    }

    public class OutletSequenceStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Pdu_4_0_1.OutletSequenceStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.OutletSequenceState newState = new Com.Raritan.Idl.pdumodel.Pdu_4_0_1.OutletSequenceState();
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetTransferSwitchesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1> _ret_;
    }
    ...
    public GetTransferSwitchesResult getTransferSwitches() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_4_0_1.StaticCast(ObjectProxy.Decode(_value, agent))));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetStatisticResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Statistic _ret_;
    }
    ...
    public GetStatisticResult getStatistic() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.Statistic.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetOutletSequenceStateResult {
      public Com.Raritan.Idl.pdumodel.Pdu_4_0_1.OutletSequenceState _ret_;
    }
    ...
    public GetOutletSequenceStateResult getOutletSequenceState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Pdu_4_0_1.OutletSequenceState.Decode(_result["_ret_"], agent);
      return _ret;
    }
