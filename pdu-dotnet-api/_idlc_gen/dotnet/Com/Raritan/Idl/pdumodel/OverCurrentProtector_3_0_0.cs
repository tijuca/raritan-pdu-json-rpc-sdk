...
namespace Com.Raritan.Idl.pdumodel {
  public class OverCurrentProtector_3_0_0 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.OverCurrentProtector:3.0.0", null);

    public OverCurrentProtector_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public OverCurrentProtector_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new OverCurrentProtector_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new OverCurrentProtector_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Type type = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Type.BREAKER_1POLE;
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.trip = Com.Raritan.Idl.sensors.StateSensor_4_0_1.StaticCast(ObjectProxy.Decode(json["trip"], agent));
      ...
      public Com.Raritan.Idl.sensors.StateSensor_4_0_1 trip = null;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.OverCurrentProtector_3_0_0.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings oldSettings = new Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings();
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings newSettings = new Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings();
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetPolesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.DoublePole_4_0_0> _ret_;
    }
    ...
    public GetPolesResult getPoles() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.DoublePole_4_0_0>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.DoublePole_4_0_0.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetInletResult {
      public Com.Raritan.Idl.pdumodel.Inlet_2_0_0 _ret_;
    }
    ...
    public GetInletResult getInlet() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Inlet_2_0_0.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetOCPResult {
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0 _ret_;
    }
    ...
    public GetOCPResult getOCP() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.OverCurrentProtector_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
