...
package Raritan::RPC::pdumodel::OutletGroupManager::GroupDeletedEvent;

use constant typeId => "pdumodel.OutletGroupManager.GroupDeletedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('pdumodel.OutletGroupManager.GroupDeletedEvent', 1, 0, 0, 'Raritan::RPC::pdumodel::OutletGroupManager::GroupDeletedEvent');
1;
