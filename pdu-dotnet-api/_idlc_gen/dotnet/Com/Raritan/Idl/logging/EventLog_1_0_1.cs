...
namespace Com.Raritan.Idl.logging {
  public class EventLog_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("logging.EventLog:1.0.1", null);

    public EventLog_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public EventLog_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new EventLog_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new EventLog_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetFilteredEntriesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.logging.LogEntry> entries;
    }

    public GetFilteredEntriesResult getFilteredEntries(int refId, int count, Com.Raritan.Idl.logging.RangeDirection direction, System.Collections.Generic.IEnumerable<string> eventClasses) {
      var _parameters = new LightJson.JsonObject();
      _parameters["refId"] = refId;
      _parameters["count"] = count;
      _parameters["direction"] = (int)direction;
      _parameters["eventClasses"] = new JsonArray(eventClasses.Select(
        _value => (JsonValue)(_value)));

      var _result = RpcCall("getFilteredEntries", _parameters);
      var _ret = new GetFilteredEntriesResult();
      _ret.entries = new System.Collections.Generic.List<Com.Raritan.Idl.logging.LogEntry>(_result["entries"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.logging.LogEntry.Decode(_value, agent)));
      return _ret;
    }

    public AsyncRequest getFilteredEntries(int refId, int count, Com.Raritan.Idl.logging.RangeDirection direction, System.Collections.Generic.IEnumerable<string> eventClasses, AsyncRpcResponse<GetFilteredEntriesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getFilteredEntries(refId, count, direction, eventClasses, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getFilteredEntries(int refId, int count, Com.Raritan.Idl.logging.RangeDirection direction, System.Collections.Generic.IEnumerable<string> eventClasses, AsyncRpcResponse<GetFilteredEntriesResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["refId"] = refId;
        _parameters["count"] = count;
      ...
      return RpcCall("getFilteredEntries", _parameters,
        _result => {
          try {
            var _ret = new GetFilteredEntriesResult();
            _ret.entries = new System.Collections.Generic.List<Com.Raritan.Idl.logging.LogEntry>(_result["entries"].AsJsonArray.Select(
