...
namespace Com.Raritan.Idl.security {
  ...
  public class IpfwRule : ICloneable {
    public object Clone() {
      IpfwRule copy = new IpfwRule();
    ...
    public static IpfwRule Decode(LightJson.JsonObject json, Agent agent) {
      IpfwRule inst = new IpfwRule();
