...
package Raritan::RPC::sensors::NumericSensor_4_0_3::Reading;
...
sub encode {
    ...
    $encoded->{'status'} = Raritan::RPC::sensors::NumericSensor_4_0_3::Reading::Status::encode($in->{'status'});
...
sub decode {
    ...
    $decoded->{'status'} = Raritan::RPC::sensors::NumericSensor_4_0_3::Reading::Status::decode($agent, $in->{'status'});
