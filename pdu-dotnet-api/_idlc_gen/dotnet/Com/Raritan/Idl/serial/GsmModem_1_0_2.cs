...
namespace Com.Raritan.Idl.serial {
  public class GsmModem_1_0_2 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("serial.GsmModem:1.0.2", null);

    public GsmModem_1_0_2(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public GsmModem_1_0_2(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new GsmModem_1_0_2 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new GsmModem_1_0_2(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public const int ERR_SIM_PROBLEM = 8;
    ...
    public class SimSecurityStatusChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("serial.GsmModem_1_0_2.SimSecurityStatusChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.serial.GsmModem_1_0_2.SimSecurityStatus newSimStatus = Com.Raritan.Idl.serial.GsmModem_1_0_2.SimSecurityStatus.UNLOCKED;
    }

    public class SimPinUpdatedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("serial.GsmModem_1_0_2.SimPinUpdatedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public string newPin = "";
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public SendTestSmsResult sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings testSettings) {
      var _parameters = new LightJson.JsonObject();
      _parameters["recipient"] = recipient;
    ...
    public AsyncRequest sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings testSettings, AsyncRpcResponse<SendTestSmsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return sendTestSms(recipient, testSettings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest sendTestSms(string recipient, Com.Raritan.Idl.serial.GsmModem_1_0_2.Settings testSettings, AsyncRpcResponse<SendTestSmsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["recipient"] = recipient;
        _parameters["testSettings"] = testSettings.Encode();
    ...
    public class GetInformationResult {
      public int _ret_;
      public Com.Raritan.Idl.serial.GsmModem_1_0_2.Information info;
    }
    ...
    public GetInformationResult getInformation() {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.info = Com.Raritan.Idl.serial.GsmModem_1_0_2.Information.Decode(_result["info"], agent);
      return _ret;
    }
    ...
    public class GetSimSecurityStatusResult {
      public int _ret_;
      public Com.Raritan.Idl.serial.GsmModem_1_0_2.SimSecurityStatus simStatus;
    }
    ...
    public GetSimSecurityStatusResult getSimSecurityStatus() {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.simStatus = (Com.Raritan.Idl.serial.GsmModem_1_0_2.SimSecurityStatus)(int)_result["simStatus"];
      return _ret;
    }
