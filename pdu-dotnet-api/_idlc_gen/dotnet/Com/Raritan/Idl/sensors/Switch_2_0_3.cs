...
namespace Com.Raritan.Idl.sensors {
  public class Switch_2_0_3 : Com.Raritan.Idl.sensors.StateSensor_4_0_2 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Switch:2.0.3", null);

    public Switch_2_0_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Switch_2_0_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Switch_2_0_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Switch_2_0_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
