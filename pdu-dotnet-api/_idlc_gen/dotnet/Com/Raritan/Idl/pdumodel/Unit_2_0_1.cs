...
namespace Com.Raritan.Idl.pdumodel {
  public class Unit_2_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Unit:2.0.1", null);

    public Unit_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Unit_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Unit_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Unit_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.supportedDisplayOrientations = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation>(json["supportedDisplayOrientations"].AsJsonArray.Select(
          _value => (Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation)(int)_value));
        return inst;
      }

      public bool hasOrientationSensor = false;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation> supportedDisplayOrientations = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation>();
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.displayOrientation = (Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation)(int)json["displayOrientation"];
        return inst;
      }

      public bool buzzerMuted = false;
      public bool autoDisplayOrientation = false;
      public Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation displayOrientation = Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation.NORMAL;
    }

    public class IdentificationStartedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Unit_2_0_1.IdentificationStartedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public int duration = 0;
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Unit_2_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Unit_2_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Unit_2_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Unit_2_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Unit_2_0_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Unit_2_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Unit_2_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetDisplayOrientationResult {
      public Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation _ret_;
    }
    ...
    public GetDisplayOrientationResult getDisplayOrientation() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.Unit_2_0_1.Orientation)(int)_result["_ret_"];
      return _ret;
    }
