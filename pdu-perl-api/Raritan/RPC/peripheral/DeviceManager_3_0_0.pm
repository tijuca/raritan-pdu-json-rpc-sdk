...
package Raritan::RPC::peripheral::DeviceManager_3_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "peripheral.DeviceManager:3.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::peripheral::DeviceManager_3_0_0::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager_3_0_0::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::peripheral::DeviceManager_3_0_0::Settings::encode($settings);
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager_3_0_0::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getDeviceTypeInfos($) {
    ...
    $_ret_ = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::peripheral::DeviceManager_3_0_0::DeviceTypeInfo::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}
...
sub getFirmwareUpdateState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager_3_0_0::FirmwareUpdateState::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getStatistics($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager_3_0_0::Statistics::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('peripheral.DeviceManager', 3, 0, 0, 'Raritan::RPC::peripheral::DeviceManager_3_0_0');
1;
