...
namespace Com.Raritan.Idl.datetime {
  public class DateTime_2_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("datetime.DateTime:2.0.0", null);

    public DateTime_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DateTime_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DateTime_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DateTime_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Cfg : ICloneable {
      ...
      public static Cfg Decode(LightJson.JsonObject json, Agent agent) {
        Cfg inst = new Cfg();
        inst.zoneCfg = Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneCfg.Decode(json["zoneCfg"], agent);
        inst.protocol = (Com.Raritan.Idl.datetime.DateTime_2_0_0.Protocol)(int)json["protocol"];
        inst.deviceTime = new System.DateTime(json["deviceTime"]);
        inst.ntpCfg = Com.Raritan.Idl.datetime.DateTime_2_0_0.NtpCfg.Decode(json["ntpCfg"], agent);
        return inst;
      }

      public Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneCfg zoneCfg = new Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneCfg();
      public Com.Raritan.Idl.datetime.DateTime_2_0_0.Protocol protocol = Com.Raritan.Idl.datetime.DateTime_2_0_0.Protocol.STATIC;
      public System.DateTime deviceTime = new System.DateTime(0);
      public Com.Raritan.Idl.datetime.DateTime_2_0_0.NtpCfg ntpCfg = new Com.Raritan.Idl.datetime.DateTime_2_0_0.NtpCfg();
    }

    public class GetZoneInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneInfo> zoneInfos;
    }
    ...
    public GetZoneInfosResult getZoneInfos(bool useOlson) {
      ...
      _ret.zoneInfos = new System.Collections.Generic.List<Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneInfo>(_result["zoneInfos"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetCfgResult {
      public Com.Raritan.Idl.datetime.DateTime_2_0_0.Cfg cfg;
    }
    ...
    public GetCfgResult getCfg() {
      ...
      _ret.cfg = Com.Raritan.Idl.datetime.DateTime_2_0_0.Cfg.Decode(_result["cfg"], agent);
      return _ret;
    }
    ...
    public SetCfgResult setCfg(Com.Raritan.Idl.datetime.DateTime_2_0_0.Cfg cfg) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setCfg(Com.Raritan.Idl.datetime.DateTime_2_0_0.Cfg cfg, AsyncRpcResponse<SetCfgResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setCfg(cfg, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setCfg(Com.Raritan.Idl.datetime.DateTime_2_0_0.Cfg cfg, AsyncRpcResponse<SetCfgResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["cfg"] = cfg.Encode();
      } catch (Exception e) {
    ...
    public class GetTimeResult {
      public Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneInfo zone;
    ...
    public GetTimeResult getTime(bool useOlson) {
      ...
      _ret.zone = Com.Raritan.Idl.datetime.DateTime_2_0_0.ZoneInfo.Decode(_result["zone"], agent);
