...
package Raritan::RPC::assetmgrmodel::AssetStrip_2_0_5::CompositionChangedEvent;

use constant typeId => "assetmgrmodel.AssetStrip_2_0_5.CompositionChangedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('assetmgrmodel.AssetStrip_2_0_5.CompositionChangedEvent', 1, 0, 0, 'Raritan::RPC::assetmgrmodel::AssetStrip_2_0_5::CompositionChangedEvent');
1;
