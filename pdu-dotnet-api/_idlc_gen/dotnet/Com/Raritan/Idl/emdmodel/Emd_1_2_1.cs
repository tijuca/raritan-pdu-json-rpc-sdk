...
namespace Com.Raritan.Idl.emdmodel {
  public class Emd_1_2_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("emdmodel.Emd:1.2.1", null);

    public Emd_1_2_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Emd_1_2_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Emd_1_2_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Emd_1_2_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.emdmodel.Emd_1_2_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd_1_2_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetExternalSensorManagerResult {
      public Com.Raritan.Idl.sensors.ExternalSensorManager_2_0_0 _ret_;
    }
    ...
    public GetExternalSensorManagerResult getExternalSensorManager() {
      ...
      _ret._ret_ = Com.Raritan.Idl.sensors.ExternalSensorManager_2_0_0.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.emdmodel.Emd_1_2_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.emdmodel.Emd_1_2_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.emdmodel.Emd_1_2_1.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd_1_2_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.emdmodel.Emd_1_2_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetSensorLoggerResult {
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_1_1 _ret_;
    }
    ...
    public GetSensorLoggerResult getSensorLogger() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.SensorLogger_1_1_1.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
