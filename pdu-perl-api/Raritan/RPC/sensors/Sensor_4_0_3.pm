...
package Raritan::RPC::sensors::Sensor_4_0_3;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "sensors.Sensor:4.0.3";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::sensors::Sensor_4_0_3::typeId;
...
use constant DOOR_STATE => 42;

use constant DOOR_LOCK_STATE => 43;

use constant DOOR_HANDLE_LOCK => 44;

use constant CREST_FACTOR => 45;
...
sub getTypeSpec($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Sensor_4_0_3::TypeSpec::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('sensors.Sensor', 4, 0, 3, 'Raritan::RPC::sensors::Sensor_4_0_3');
1;
