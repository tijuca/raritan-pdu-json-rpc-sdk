...
package Raritan::RPC::peripheral::DeviceSlot_2_0_2::DeviceChangedEvent;

use constant typeId => "peripheral.DeviceSlot_2_0_2.DeviceChangedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('peripheral.DeviceSlot_2_0_2.DeviceChangedEvent', 1, 0, 0, 'Raritan::RPC::peripheral::DeviceSlot_2_0_2::DeviceChangedEvent');
1;
