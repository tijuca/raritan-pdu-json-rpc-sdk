...
namespace Com.Raritan.Idl.peripheral {
  ...
  public class Device : ValueObject {
    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.Device:1.0.0", ValueObject.typeInfo);

    public Com.Raritan.Idl.peripheral.DeviceID deviceID = new Com.Raritan.Idl.peripheral.DeviceID();
    ...
    public Com.Raritan.Idl.sensors.Sensor_3_0_0 device = null;
  }
}
