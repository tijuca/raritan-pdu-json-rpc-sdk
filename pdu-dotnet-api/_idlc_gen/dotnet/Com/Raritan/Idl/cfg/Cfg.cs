...
namespace Com.Raritan.Idl.cfg {
  public class Cfg : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("cfg.Cfg:1.0.0", null);

    public Cfg(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Cfg(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Cfg StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Cfg(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
