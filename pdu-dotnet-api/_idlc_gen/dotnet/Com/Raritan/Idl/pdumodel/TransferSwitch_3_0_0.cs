...
namespace Com.Raritan.Idl.pdumodel {
  public class TransferSwitch_3_0_0 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.TransferSwitch:3.0.0", null);

    public TransferSwitch_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public TransferSwitch_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new TransferSwitch_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new TransferSwitch_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Type type = Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Type.STS;
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetLastTransferReasonResult {
      public Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.TransferReason _ret_;
    }
    ...
    public GetLastTransferReasonResult getLastTransferReason() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.TransferReason)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetLastTransferWaveformResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.WaveformSample> _ret_;
    }
    ...
    public GetLastTransferWaveformResult getLastTransferWaveform() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.WaveformSample>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.TransferSwitch_3_0_0.WaveformSample.Decode(_value, agent)));
      return _ret;
    }
