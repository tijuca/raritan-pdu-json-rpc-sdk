...
namespace Com.Raritan.Idl.peripheral {
  ...
  public class Address_3_0_1 : ICloneable {
    public object Clone() {
      Address_3_0_1 copy = new Address_3_0_1();
    ...
    public static Address_3_0_1 Decode(LightJson.JsonObject json, Agent agent) {
      Address_3_0_1 inst = new Address_3_0_1();
