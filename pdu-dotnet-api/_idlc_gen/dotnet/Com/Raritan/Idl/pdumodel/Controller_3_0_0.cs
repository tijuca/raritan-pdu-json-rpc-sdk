...
namespace Com.Raritan.Idl.pdumodel {
  public class Controller_3_0_0 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Controller:3.0.0", null);

    public Controller_3_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Controller_3_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Controller_3_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Controller_3_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MetaData : ICloneable {
      ...
      public static MetaData Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.Controller_3_0_0.Type)(int)json["type"];
      ...
      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.Type type = Com.Raritan.Idl.pdumodel.Controller_3_0_0.Type.OUTLET_CTRL;
    ...
    public class StatusChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Controller_3_0_0.StatusChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status oldStatus = Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status.OK;
      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status newStatus = Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status.OK;
    }

    public class MetaDataChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Controller_3_0_0.MetaDataChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData oldMetaData = new Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData();
      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData newMetaData = new Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData();
    }

    public class GetCommunicationStatusResult {
      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status _ret_;
    }
    ...
    public GetCommunicationStatusResult getCommunicationStatus() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.pdumodel.Controller_3_0_0.Status)(int)_result["_ret_"];
      return _ret;
    }
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Controller_3_0_0.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
