...
namespace Com.Raritan.Idl.net {
  public class Net_4_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("net.Net:4.0.1", null);

    public Net_4_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Net_4_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Net_4_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Net_4_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public const int ERR_WLAN_IF_INVALID_EAP_AUTH_SERVER_NAME = 607;
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.net.Settings_2_0_0 _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.net.Settings_2_0_0.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.net.Settings_2_0_0 settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.net.Settings_2_0_0 settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.net.Settings_2_0_0 settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
