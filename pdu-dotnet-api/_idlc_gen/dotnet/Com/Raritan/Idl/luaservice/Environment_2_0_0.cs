...
namespace Com.Raritan.Idl.luaservice {
  ...
  public class Environment_2_0_0 : ICloneable {
    public object Clone() {
      Environment_2_0_0 copy = new Environment_2_0_0();
      copy.maxScriptMemoryGrowth = this.maxScriptMemoryGrowth;
    ...
    public LightJson.JsonObject Encode() {
      ...
      json["maxScriptMemoryGrowth"] = this.maxScriptMemoryGrowth;
    ...
    public static Environment_2_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      Environment_2_0_0 inst = new Environment_2_0_0();
      inst.maxScriptMemoryGrowth = (int)json["maxScriptMemoryGrowth"];
    ...
    public int maxScriptMemoryGrowth = 0;
