...
package Raritan::RPC::pdumodel::Outlet_2_1_5;

use parent qw(Raritan::RPC::pdumodel::EDevice);

use constant typeId => "pdumodel.Outlet:2.1.5";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Outlet_2_1_5::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_5::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_5::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_5::State::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Outlet_2_1_5::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Outlet_2_1_5::Settings::encode($settings);
...
sub getIOP($$$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'p'}}; $i0++) {
        $$p->[$i0] = Raritan::RPC::pdumodel::Pole_5_0_0::decode($agent, $rsp->{'p'}->[$i0]);
    }
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Outlet', 2, 1, 5, 'Raritan::RPC::pdumodel::Outlet_2_1_5');
1;
