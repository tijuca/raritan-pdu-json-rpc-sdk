...
package Raritan::RPC::net::Net_5_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "net.Net:5.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::net::Net_5_0_0::typeId;
...
use constant ERR_IF_EAP_INVALID_IDENTITY => 408;

use constant ERR_IF_EAP_INVALID_PASSWORD => 409;

use constant ERR_IF_EAP_INVALID_CLIENT_CERT => 410;

use constant ERR_IF_EAP_INVALID_CLIENT_PRIV_KEY_OR_PWD => 411;

use constant ERR_IF_EAP_CLIENT_CERT_PRIV_KEY_MISMATCH => 412;

use constant ERR_IF_EAP_INVALID_CA_CERT => 413;

use constant ERR_IF_EAP_CA_CERT_VERIFY_FAILED => 414;

use constant ERR_IF_EAP_INVALID_AUTH_SERVER_NAME => 415;
...
sub getInfo($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::net::Info_1_0_1::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::net::Settings_3_0_0::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::net::Settings_3_0_0::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('net.Net', 5, 0, 0, 'Raritan::RPC::net::Net_5_0_0');
1;
