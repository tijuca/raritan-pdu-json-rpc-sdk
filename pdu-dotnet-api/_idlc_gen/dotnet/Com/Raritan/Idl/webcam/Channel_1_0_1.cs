...
namespace Com.Raritan.Idl.webcam {
  public class Channel_1_0_1 : ObjectProxy {
    ...
    static public readonly new TypeInfo typeInfo = new TypeInfo("webcam.Channel:1.0.1", null);
    ...
    public class GetWebcamResult {
      public Com.Raritan.Idl.webcam.Webcam_2_0_1 _ret_;
    }
    ...
    public GetWebcamResult getWebcam() {
      ...
      _ret._ret_ = Com.Raritan.Idl.webcam.Webcam_2_0_1.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
