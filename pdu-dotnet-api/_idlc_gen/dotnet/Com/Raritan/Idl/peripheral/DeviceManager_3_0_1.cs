...
namespace Com.Raritan.Idl.peripheral {
  public class DeviceManager_3_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager:3.0.1", null);

    public DeviceManager_3_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public DeviceManager_3_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new DeviceManager_3_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new DeviceManager_3_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.zCoordMode = (Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.ZCoordMode)(int)json["zCoordMode"];
      ...
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.ZCoordMode zCoordMode = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.ZCoordMode.RACKUNITS;
    ...
    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings oldSettings = new Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings();
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings newSettings = new Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings();
    }

    public class DeviceEvent_2_0_0 : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.DeviceEvent:2.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class DeviceAddedEvent_2_0_0 : Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceEvent_2_0_0 {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.DeviceAddedEvent:2.0.0", Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceEvent_2_0_0.typeInfo);

    }

    public class DeviceRemovedEvent_2_0_0 : Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceEvent_2_0_0 {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.DeviceRemovedEvent:2.0.0", Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceEvent_2_0_0.typeInfo);

    }

    public class UnknownDeviceAttachedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.UnknownDeviceAttachedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class DeviceFirmwareUpdateStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.DeviceFirmwareUpdateStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public string oldVersion = "";
      public string newVersion = "";
      public string serial = "";
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceFirmwareUpdateState state = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceFirmwareUpdateState.UPDATE_STARTED;
    }

    public class FirmwareUpdateStateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.FirmwareUpdateStateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.FirmwareUpdateState newState = new Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.FirmwareUpdateState();
    }

    public class PackageEvent_2_0_0 : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.PackageEvent:2.0.0", Com.Raritan.Idl.idl.Event.typeInfo);
    ...
    public class PackageAddedEvent_2_0_0 : Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0 {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.PackageAddedEvent:2.0.0", Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0.typeInfo);

    }

    public class PackageRemovedEvent_2_0_0 : Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0 {
      static public readonly new TypeInfo typeInfo = new TypeInfo("peripheral.DeviceManager_3_0_1.PackageRemovedEvent:2.0.0", Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0.typeInfo);
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetMetaDataResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetDeviceTypeInfosResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceTypeInfo> _ret_;
    }
    ...
    public GetDeviceTypeInfosResult getDeviceTypeInfos() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceTypeInfo>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.DeviceTypeInfo.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetFirmwareUpdateStateResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.FirmwareUpdateState _ret_;
    }
    ...
    public GetFirmwareUpdateStateResult getFirmwareUpdateState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.FirmwareUpdateState.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetStatisticsResult {
      public Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Statistics _ret_;
    }
    ...
    public GetStatisticsResult getStatistics() {
      ...
      _ret._ret_ = Com.Raritan.Idl.peripheral.DeviceManager_3_0_1.Statistics.Decode(_result["_ret_"], agent);
      return _ret;
    }
