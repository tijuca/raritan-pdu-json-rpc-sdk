...
namespace Com.Raritan.Idl.peripheral {
  ...
  public class DeviceID_3_0_0 : ICloneable {
    public object Clone() {
      DeviceID_3_0_0 copy = new DeviceID_3_0_0();
    ...
    public static DeviceID_3_0_0 Decode(LightJson.JsonObject json, Agent agent) {
      DeviceID_3_0_0 inst = new DeviceID_3_0_0();
