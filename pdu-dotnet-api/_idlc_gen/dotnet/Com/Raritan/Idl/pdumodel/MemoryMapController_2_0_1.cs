...
namespace Com.Raritan.Idl.pdumodel {
  public class MemoryMapController_2_0_1 : Com.Raritan.Idl.pdumodel.Controller_2_0_1 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.MemoryMapController:2.0.1", null);

    public MemoryMapController_2_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public MemoryMapController_2_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new MemoryMapController_2_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new MemoryMapController_2_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
