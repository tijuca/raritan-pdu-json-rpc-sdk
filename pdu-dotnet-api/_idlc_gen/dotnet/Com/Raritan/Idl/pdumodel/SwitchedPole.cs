...
namespace Com.Raritan.Idl.pdumodel {
  ...
  public class SwitchedPole : ICloneable {
    public object Clone() {
      SwitchedPole copy = new SwitchedPole();
    ...
    public static SwitchedPole Decode(LightJson.JsonObject json, Agent agent) {
      SwitchedPole inst = new SwitchedPole();
