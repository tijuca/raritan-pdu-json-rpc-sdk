...
namespace Com.Raritan.Idl.pdumodel {
  public class Circuit_1_0_3 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Circuit:1.0.3", null);

    public Circuit_1_0_3(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Circuit_1_0_3(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Circuit_1_0_3 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Circuit_1_0_3(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class Config : ICloneable {
      ...
      public static Config Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.type = (Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Type)(int)json["type"];
        return inst;
      }

      public int position = 0;
      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Type type = Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Type.ONE_PHASE_LN;
    }

    public class GetConfigResult {
      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Config _ret_;
    }
    ...
    public GetConfigResult getConfig() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Config.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.poleSettings = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Circuit_1_0_3.PoleSettings>(json["poleSettings"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.Circuit_1_0_3.PoleSettings.Decode(_value, agent)));
        return inst;
      }
      ...
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Circuit_1_0_3.PoleSettings> poleSettings = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Circuit_1_0_3.PoleSettings>();
    }

    public class SettingsChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Circuit_1_0_3.SettingsChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings oldSettings = new Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings();
      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings newSettings = new Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings();
    }

    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings settings) {
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Circuit_1_0_3.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
