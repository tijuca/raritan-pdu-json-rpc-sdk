...
namespace Com.Raritan.Idl.sensors {
  ...
  public class ExternalSensorData : ICloneable {
    public object Clone() {
      ExternalSensorData copy = new ExternalSensorData();
    ...
    public static ExternalSensorData Decode(LightJson.JsonObject json, Agent agent) {
      ExternalSensorData inst = new ExternalSensorData();
