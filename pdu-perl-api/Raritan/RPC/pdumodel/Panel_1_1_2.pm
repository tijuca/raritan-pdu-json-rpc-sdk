...
package Raritan::RPC::pdumodel::Panel_1_1_2;

use parent qw(Raritan::RPC::pdumodel::PowerMeter_1_1_2);

use constant typeId => "pdumodel.Panel:1.1.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Panel_1_1_2::typeId;
...
sub getPanelSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Panel_1_1_2::PanelSettings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setPanelSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Panel_1_1_2::PanelSettings::encode($settings);
...
sub createCircuit($$$$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'config'} = Raritan::RPC::pdumodel::Circuit_1_0_1::Config::encode($config);
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Panel', 1, 1, 2, 'Raritan::RPC::pdumodel::Panel_1_1_2');
1;
