...
namespace Com.Raritan.Idl._event {
  public class Engine : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("event.Engine:1.0.0", null);

    public Engine(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Engine(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Engine StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Engine(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class EventDesc : ICloneable {
      ...
      public static EventDesc Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.eventDescType = (Com.Raritan.Idl._event.Engine.EventDesc.Type)(int)json["eventDescType"];
        ...
        inst.entries = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.EventDesc>(json["entries"].AsJsonArray.Select(
          _value => Com.Raritan.Idl._event.Engine.EventDesc.Decode(_value, agent)));
        return inst;
      }
      ...
      public Com.Raritan.Idl._event.Engine.EventDesc.Type eventDescType = Com.Raritan.Idl._event.Engine.EventDesc.Type.NODE;
      ...
      public string name = "";
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl._event.Engine.EventDesc> entries = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.EventDesc>();
    }

    public class ListEventDescsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl._event.Engine.EventDesc> eventDescs;
    }
    ...
    public ListEventDescsResult listEventDescs(System.Collections.Generic.IEnumerable<string> eventIdPrefix) {
      ...
      _ret.eventDescs = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.EventDesc>(_result["eventDescs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl._event.Engine.EventDesc.Decode(_value, agent)));
      return _ret;
    }
    ...
    public AddActionResult addAction(Com.Raritan.Idl._event.Engine.Action action) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest addAction(Com.Raritan.Idl._event.Engine.Action action, AsyncRpcResponse<AddActionResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return addAction(action, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest addAction(Com.Raritan.Idl._event.Engine.Action action, AsyncRpcResponse<AddActionResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["action"] = action.Encode();
      } catch (Exception e) {
    ...
    public ModifyActionResult modifyAction(Com.Raritan.Idl._event.Engine.Action action) {
      var _parameters = new LightJson.JsonObject();
      _parameters["action"] = action.Encode();
    ...
    public AsyncRequest modifyAction(Com.Raritan.Idl._event.Engine.Action action, AsyncRpcResponse<ModifyActionResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return modifyAction(action, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest modifyAction(Com.Raritan.Idl._event.Engine.Action action, AsyncRpcResponse<ModifyActionResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["action"] = action.Encode();
      } catch (Exception e) {
    ...
    public class ListActionsResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl._event.Engine.Action> _ret_;
    }
    ...
    public ListActionsResult listActions() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.Action>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl._event.Engine.Action.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class Condition : ICloneable {
      ...
      public static Condition Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.operation = (Com.Raritan.Idl._event.Engine.Condition.Op)(int)json["operation"];
        inst.matchType = (Com.Raritan.Idl._event.Engine.Condition.MatchType)(int)json["matchType"];
        inst.eventId = new System.Collections.Generic.List<string>(json["eventId"].AsJsonArray.Select(
          _value => (string)_value));
        inst.conditions = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.Condition>(json["conditions"].AsJsonArray.Select(
          _value => Com.Raritan.Idl._event.Engine.Condition.Decode(_value, agent)));
        return inst;
      }
      ...
      public Com.Raritan.Idl._event.Engine.Condition.Op operation = Com.Raritan.Idl._event.Engine.Condition.Op.AND;
      public Com.Raritan.Idl._event.Engine.Condition.MatchType matchType = Com.Raritan.Idl._event.Engine.Condition.MatchType.ASSERTED;
      public System.Collections.Generic.IEnumerable<string> eventId = new System.Collections.Generic.List<string>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl._event.Engine.Condition> conditions = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.Condition>();
    }
    ...
    public class Rule : ICloneable {
      ...
      public static Rule Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.condition = Com.Raritan.Idl._event.Engine.Condition.Decode(json["condition"], agent);
      ...
      public Com.Raritan.Idl._event.Engine.Condition condition = new Com.Raritan.Idl._event.Engine.Condition();
    ...
    public AddRuleResult addRule(Com.Raritan.Idl._event.Engine.Rule rule) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest addRule(Com.Raritan.Idl._event.Engine.Rule rule, AsyncRpcResponse<AddRuleResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return addRule(rule, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest addRule(Com.Raritan.Idl._event.Engine.Rule rule, AsyncRpcResponse<AddRuleResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["rule"] = rule.Encode();
      } catch (Exception e) {
    ...
    public ModifyRuleResult modifyRule(Com.Raritan.Idl._event.Engine.Rule rule) {
      var _parameters = new LightJson.JsonObject();
      _parameters["rule"] = rule.Encode();
    ...
    public AsyncRequest modifyRule(Com.Raritan.Idl._event.Engine.Rule rule, AsyncRpcResponse<ModifyRuleResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return modifyRule(rule, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest modifyRule(Com.Raritan.Idl._event.Engine.Rule rule, AsyncRpcResponse<ModifyRuleResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["rule"] = rule.Encode();
      } catch (Exception e) {
    ...
    public class ListRulesResult {
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl._event.Engine.Rule> _ret_;
    }
    ...
    public ListRulesResult listRules() {
      ...
      _ret._ret_ = new System.Collections.Generic.List<Com.Raritan.Idl._event.Engine.Rule>(_result["_ret_"].AsJsonArray.Select(
        _value => Com.Raritan.Idl._event.Engine.Rule.Decode(_value, agent)));
      return _ret;
    }
