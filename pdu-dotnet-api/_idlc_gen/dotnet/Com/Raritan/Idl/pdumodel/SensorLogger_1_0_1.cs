...
namespace Com.Raritan.Idl.pdumodel {
  public class SensorLogger_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.SensorLogger:1.0.1", null);

    public SensorLogger_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public SensorLogger_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new SensorLogger_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new SensorLogger_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class Record : ICloneable {
      ...
      public static Record Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.state = (Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorState)(int)json["state"];
      ...
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorState state = Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorState.UNAVAILABLE;
    ...
    public class GetSensorRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record> recs;
    }

    public GetSensorRecordsResult getSensorRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count) {
      var _parameters = new LightJson.JsonObject();
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record.Decode(_value, agent)));
      return _ret;
    }

    public AsyncRequest getSensorRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count, AsyncRpcResponse<GetSensorRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getSensorRecords(sensor, recid, count, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getSensorRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count, AsyncRpcResponse<GetSensorRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensor"] = sensor != null ? sensor.Encode() : JsonValue.Null;
        _parameters["recid"] = recid;
    ...
    public GetExternalSensorRecordsResult getExternalSensorRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest getExternalSensorRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count, AsyncRpcResponse<GetExternalSensorRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getExternalSensorRecords(extsensor, recid, count, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getExternalSensorRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count, AsyncRpcResponse<GetExternalSensorRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["extsensor"] = extsensor != null ? extsensor.Encode() : JsonValue.Null;
        _parameters["recid"] = recid;
    ...
    public class TimedRecord : ICloneable {
      ...
      public static TimedRecord Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.record = Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record.Decode(json["record"], agent);
        return inst;
      }

      public System.DateTime timestamp = new System.DateTime(0);
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record record = new Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record();
    }

    public class GetSensorTimedRecordsResult {
      public int _ret_;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.TimedRecord> recs;
    }

    public GetSensorTimedRecordsResult getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count) {
      var _parameters = new LightJson.JsonObject();
      _parameters["sensor"] = sensor != null ? sensor.Encode() : JsonValue.Null;
      _parameters["recid"] = recid;
      _parameters["count"] = count;
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.recs = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.TimedRecord>(_result["recs"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.TimedRecord.Decode(_value, agent)));
      return _ret;
    }

    public AsyncRequest getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count, AsyncRpcResponse<GetSensorTimedRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getSensorTimedRecords(sensor, recid, count, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getSensorTimedRecords(Com.Raritan.Idl.sensors.Sensor sensor, int recid, int count, AsyncRpcResponse<GetSensorTimedRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensor"] = sensor != null ? sensor.Encode() : JsonValue.Null;
        _parameters["recid"] = recid;
    ...
    public GetExtSensorTimedRecordsResult getExtSensorTimedRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count) {
      var _parameters = new LightJson.JsonObject();
      _parameters["extsensor"] = extsensor != null ? extsensor.Encode() : JsonValue.Null;
      _parameters["recid"] = recid;
      _parameters["count"] = count;
    ...
    public AsyncRequest getExtSensorTimedRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count, AsyncRpcResponse<GetExtSensorTimedRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return getExtSensorTimedRecords(extsensor, recid, count, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest getExtSensorTimedRecords(Com.Raritan.Idl.sensors.ExternalSensorSlot extsensor, int recid, int count, AsyncRpcResponse<GetExtSensorTimedRecordsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["extsensor"] = extsensor != null ? extsensor.Encode() : JsonValue.Null;
        _parameters["recid"] = recid;
    ...
    public class SensorSet : ICloneable {
      ...
      public static SensorSet Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.sensors = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Sensor>(json["sensors"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.Sensor.StaticCast(ObjectProxy.Decode(_value, agent))));
        inst.extsens = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.ExternalSensorSlot>(json["extsens"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.sensors.ExternalSensorSlot.StaticCast(ObjectProxy.Decode(_value, agent))));
        return inst;
      }

      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.Sensor> sensors = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.Sensor>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.sensors.ExternalSensorSlot> extsens = new System.Collections.Generic.List<Com.Raritan.Idl.sensors.ExternalSensorSlot>();
    }

    public class GetLoggedSensorsResult {
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorSet _ret_;
    }
    ...
    public GetLoggedSensorsResult getLoggedSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorSet.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetLoggedSensorsResult setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorSet sensors) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setLoggedSensors(sensors, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setLoggedSensors(Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.SensorSet sensors, AsyncRpcResponse<SetLoggedSensorsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["sensors"] = sensors.Encode();
      } catch (Exception e) {
    ...
    public class LogRow : ICloneable {
      ...
      public static LogRow Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.timestamp = new System.DateTime(json["timestamp"]);
        inst.sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record>(json["sensorRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record.Decode(_value, agent)));
        inst.extsensRecords = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record>(json["extsensRecords"].AsJsonArray.Select(
          _value => Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record.Decode(_value, agent)));
        return inst;
      }
      ...
      public System.DateTime timestamp = new System.DateTime(0);
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record> sensorRecords = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record>();
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record> extsensRecords = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.Record>();
    }

    public class GetLogRowResult {
      public int _ret_;
      public Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.LogRow row;
    }
    ...
    public GetLogRowResult getLogRow(int recid) {
      ...
      _ret._ret_ = (int)_result["_ret_"];
      _ret.row = Com.Raritan.Idl.pdumodel.SensorLogger_1_0_1.LogRow.Decode(_result["row"], agent);
      return _ret;
    }
