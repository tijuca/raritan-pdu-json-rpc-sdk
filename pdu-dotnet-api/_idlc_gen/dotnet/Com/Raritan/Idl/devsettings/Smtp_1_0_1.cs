...
namespace Com.Raritan.Idl.devsettings {
  public class Smtp_1_0_1 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("devsettings.Smtp:1.0.1", null);

    public Smtp_1_0_1(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Smtp_1_0_1(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Smtp_1_0_1 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Smtp_1_0_1(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class GetConfigurationResult {
      public Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration _ret_;
    }
    ...
    public GetConfigurationResult getConfiguration() {
      ...
      _ret._ret_ = Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetConfigurationResult setConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg) {
    ...
    public AsyncRequest setConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg, AsyncRpcResponse<SetConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setConfiguration(cfg, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg, AsyncRpcResponse<SetConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["cfg"] = cfg.Encode();
      } catch (Exception e) {
    ...
    public class TestConfigurationResult {
      public Com.Raritan.Idl.devsettings.Smtp_1_0_1.TestResult _ret_;
    }

    public TestConfigurationResult testConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg, System.Collections.Generic.IEnumerable<string> recipients) {
      var _parameters = new LightJson.JsonObject();
      _parameters["cfg"] = cfg.Encode();
      ...
      _ret._ret_ = Com.Raritan.Idl.devsettings.Smtp_1_0_1.TestResult.Decode(_result["_ret_"], agent);
      return _ret;
    }

    public AsyncRequest testConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg, System.Collections.Generic.IEnumerable<string> recipients, AsyncRpcResponse<TestConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return testConfiguration(cfg, recipients, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest testConfiguration(Com.Raritan.Idl.devsettings.Smtp_1_0_1.Configuration cfg, System.Collections.Generic.IEnumerable<string> recipients, AsyncRpcResponse<TestConfigurationResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["cfg"] = cfg.Encode();
        _parameters["recipients"] = new JsonArray(recipients.Select(
