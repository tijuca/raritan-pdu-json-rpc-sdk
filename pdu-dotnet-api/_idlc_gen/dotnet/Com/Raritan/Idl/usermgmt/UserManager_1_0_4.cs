...
namespace Com.Raritan.Idl.usermgmt {
  public class UserManager_1_0_4 : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("usermgmt.UserManager:1.0.4", null);

    public UserManager_1_0_4(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public UserManager_1_0_4(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new UserManager_1_0_4 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new UserManager_1_0_4(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public const int ERR_USERNAME_INVALID = 18;
