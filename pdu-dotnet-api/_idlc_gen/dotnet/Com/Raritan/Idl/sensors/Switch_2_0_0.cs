...
namespace Com.Raritan.Idl.sensors {
  public class Switch_2_0_0 : Com.Raritan.Idl.sensors.StateSensor_4_0_0 {

    static public readonly new TypeInfo typeInfo = new TypeInfo("sensors.Switch:2.0.0", null);

    public Switch_2_0_0(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Switch_2_0_0(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Switch_2_0_0 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Switch_2_0_0(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
