...
namespace Com.Raritan.Idl.pdumodel {
  public class Outlet_1_4_5 : Com.Raritan.Idl.pdumodel.EDevice {

    static public readonly new TypeInfo typeInfo = new TypeInfo("pdumodel.Outlet:1.4.5", null);

    public Outlet_1_4_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public Outlet_1_4_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new Outlet_1_4_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new Outlet_1_4_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class State : ICloneable {
      ...
      public static State Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.powerState = (Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState)(int)json["powerState"];
        inst.switchOnInProgress = (bool)json["switchOnInProgress"];
        inst.cycleInProgress = (bool)json["cycleInProgress"];
        inst.ledState = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.LedState.Decode(json["ledState"], agent);
        inst.lastPowerStateChange = new System.DateTime(json["lastPowerStateChange"]);
        return inst;
      }

      public bool available = false;
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState powerState = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState.PS_OFF;
      public bool switchOnInProgress = false;
      public bool cycleInProgress = false;
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.LedState ledState = new Com.Raritan.Idl.pdumodel.Outlet_1_4_5.LedState();
    ...
    public class Settings : ICloneable {
      ...
      public static Settings Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.startupState = (Com.Raritan.Idl.pdumodel.Outlet_1_4_5.StartupState)(int)json["startupState"];
      ...
      public string name = "";
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.StartupState startupState = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.StartupState.SS_ON;
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.maximumCurrent = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["maximumCurrent"], agent));
        ...
        inst.phaseAngle = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["phaseAngle"], agent));
        inst.lineFrequency = Com.Raritan.Idl.sensors.NumericSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["lineFrequency"], agent));
        inst.outletState = Com.Raritan.Idl.sensors.StateSensor_3_0_1.StaticCast(ObjectProxy.Decode(json["outletState"], agent));
        return inst;
      }
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1 maximumCurrent = null;
      ...
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1 phaseAngle = null;
      public Com.Raritan.Idl.sensors.NumericSensor_3_0_1 lineFrequency = null;
      public Com.Raritan.Idl.sensors.StateSensor_3_0_1 outletState = null;
    }

    public class GetMetaDataResult {
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.MetaData _ret_;
    }
    ...
    public GetMetaDataResult getMetaData() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.MetaData.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSensorsResult {
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.State _ret_;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.State.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetPowerStateResult setPowerState(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState pstate) {
    ...
    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setPowerState(pstate, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setPowerState(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.PowerState pstate, AsyncRpcResponse<SetPowerStateResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["pstate"] = (int)pstate;
      } catch (Exception e) {
    ...
    public class GetSettingsResult {
      public Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Settings _ret_;
    }
    ...
    public GetSettingsResult getSettings() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Settings.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public SetSettingsResult setSettings(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Settings settings) {
      var _parameters = new LightJson.JsonObject();
    ...
    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail) {
      return setSettings(settings, rsp, fail, RpcCtrl.Default);
    }

    public AsyncRequest setSettings(Com.Raritan.Idl.pdumodel.Outlet_1_4_5.Settings settings, AsyncRpcResponse<SetSettingsResult>.SuccessHandler rsp, AsyncRpcResponse.FailureHandler fail, RpcCtrl rpcCtrl) {
      var _parameters = new LightJson.JsonObject();
      try {
        _parameters["settings"] = settings.Encode();
      } catch (Exception e) {
    ...
    public class GetIOPResult {
      public Com.Raritan.Idl.pdumodel.Inlet_1_1_5 i;
      public Com.Raritan.Idl.pdumodel.OverCurrentProtector_2_0_1 o;
      public System.Collections.Generic.IEnumerable<Com.Raritan.Idl.pdumodel.Pole_1_1_1> p;
    }
    ...
    public GetIOPResult getIOP() {
      ...
      _ret.i = Com.Raritan.Idl.pdumodel.Inlet_1_1_5.StaticCast(ObjectProxy.Decode(_result["i"], agent));
      _ret.o = Com.Raritan.Idl.pdumodel.OverCurrentProtector_2_0_1.StaticCast(ObjectProxy.Decode(_result["o"], agent));
      _ret.p = new System.Collections.Generic.List<Com.Raritan.Idl.pdumodel.Pole_1_1_1>(_result["p"].AsJsonArray.Select(
        _value => Com.Raritan.Idl.pdumodel.Pole_1_1_1.Decode(_value, agent)));
      return _ret;
    }
    ...
    public class GetControllerResult {
      public Com.Raritan.Idl.pdumodel.Controller_2_0_1 _ret_;
    }
    ...
    public GetControllerResult getController() {
      ...
      _ret._ret_ = Com.Raritan.Idl.pdumodel.Controller_2_0_1.StaticCast(ObjectProxy.Decode(_result["_ret_"], agent));
      return _ret;
    }
