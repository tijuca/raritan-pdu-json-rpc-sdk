...
namespace Com.Raritan.Idl.hmi {
  public class InternalBeeper : ObjectProxy {

    static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper:1.0.0", null);

    public InternalBeeper(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public InternalBeeper(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new InternalBeeper StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new InternalBeeper(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MuteChangedEvent : Com.Raritan.Idl._event.UserEvent {
      static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper.MuteChangedEvent:1.0.0", Com.Raritan.Idl._event.UserEvent.typeInfo);

      public bool muted = false;
    }

    public class StateChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("hmi.InternalBeeper.StateChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.hmi.InternalBeeper.State state = Com.Raritan.Idl.hmi.InternalBeeper.State.OFF;
    ...
    public class GetStateResult {
      public Com.Raritan.Idl.hmi.InternalBeeper.State _ret_;
      public string reason;
    }
    ...
    public GetStateResult getState() {
      ...
      _ret._ret_ = (Com.Raritan.Idl.hmi.InternalBeeper.State)(int)_result["_ret_"];
