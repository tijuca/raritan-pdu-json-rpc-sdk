...
namespace Com.Raritan.Idl.powerlogic {
  public class PowerMeter_1_2_5 : Com.Raritan.Idl.modbus.Device {

    static public readonly new TypeInfo typeInfo = new TypeInfo("powerlogic.PowerMeter:1.2.5", null);

    public PowerMeter_1_2_5(Agent agent, string rid, TypeInfo ti) : base(agent, rid, ti) {}
    public PowerMeter_1_2_5(Agent agent, string rid) : this(agent, rid, typeInfo) {}

    public static new PowerMeter_1_2_5 StaticCast(ObjectProxy proxy) {
      return proxy == null ? null : new PowerMeter_1_2_5(proxy.Agent, proxy.Rid, proxy.StaticTypeInfo);
    }
    ...
    public class MinMaxReading : ICloneable {
      ...
      public static MinMaxReading Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.min = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["min"], agent));
        inst.max = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["max"], agent));
        inst.reading = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["reading"], agent));
        return inst;
      }

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 min = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 max = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 reading = null;
    }
    ...
    public class L2N_N_Avg : ICloneable {
      ...
      public static L2N_N_Avg Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.l1 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l1"], agent);
        inst.l2 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l2"], agent);
        inst.l3 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l3"], agent);
        inst.n = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["n"], agent));
        inst.average = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["average"], agent));
        return inst;
      }

      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l1 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l2 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l3 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 n = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 average = null;
    }
    ...
    public class L2L_Avg : ICloneable {
      ...
      public static L2L_Avg Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.l1l2 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l1l2"], agent);
        inst.l2l3 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l2l3"], agent);
        inst.l3l1 = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["l3l1"], agent);
        inst.average = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["average"], agent));
        return inst;
      }

      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l1l2 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l2l3 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading l3l1 = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 average = null;
    }
    ...
    public class L2N_plain_total : ICloneable {
      ...
      public static L2N_plain_total Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.l1 = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["l1"], agent));
        inst.l2 = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["l2"], agent));
        inst.l3 = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["l3"], agent));
        inst.total = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["total"], agent);
        return inst;
      }

      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 l1 = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 l2 = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 l3 = null;
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading total = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
    }
    ...
    public class Sensors : ICloneable {
      ...
      public static Sensors Decode(LightJson.JsonObject json, Agent agent) {
        ...
        inst.current = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_N_Avg.Decode(json["current"], agent);
        inst.voltageL2L = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L_Avg.Decode(json["voltageL2L"], agent);
        inst.voltageL2N = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_Avg.Decode(json["voltageL2N"], agent);
        inst.frequency = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["frequency"], agent));
        inst.activePower = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total.Decode(json["activePower"], agent);
        inst.reactivePower = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total.Decode(json["reactivePower"], agent);
        inst.apparentPower = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total.Decode(json["apparentPower"], agent);
        inst.powerFactor = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading.Decode(json["powerFactor"], agent);
        inst.activeEnergy = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["activeEnergy"], agent));
        inst.reactiveEnergy = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["reactiveEnergy"], agent));
        inst.apparentEnergy = Com.Raritan.Idl.sensors.NumericSensor_4_0_3.StaticCast(ObjectProxy.Decode(json["apparentEnergy"], agent));
        inst.thdCurrent = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N.Decode(json["thdCurrent"], agent);
        inst.thdVoltageL2L = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L.Decode(json["thdVoltageL2L"], agent);
        inst.thdVoltageL2N = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N.Decode(json["thdVoltageL2N"], agent);
        return inst;
      }

      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_N_Avg current = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_N_Avg();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L_Avg voltageL2L = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L_Avg();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_Avg voltageL2N = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_Avg();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 frequency = null;
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total activePower = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total reactivePower = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total apparentPower = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N_plain_total();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading powerFactor = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.MinMaxReading();
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 activeEnergy = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 reactiveEnergy = null;
      public Com.Raritan.Idl.sensors.NumericSensor_4_0_3 apparentEnergy = null;
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N thdCurrent = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L thdVoltageL2L = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2L();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N thdVoltageL2N = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.L2N();
    }
    ...
    public class SetupChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("powerlogic.PowerMeter_1_2_5.SetupChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup oldSetup = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup newSetup = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup();
    }

    public class ErrorStatusChangedEvent : Com.Raritan.Idl.idl.Event {
      static public readonly new TypeInfo typeInfo = new TypeInfo("powerlogic.PowerMeter_1_2_5.ErrorStatusChangedEvent:1.0.0", Com.Raritan.Idl.idl.Event.typeInfo);

      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus oldStatus = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus();
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus newStatus = new Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus();
    }

    public class GetSensorsResult {
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Sensors _ret_;
    }
    ...
    public GetSensorsResult getSensors() {
      ...
      _ret._ret_ = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Sensors.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetSetupResult {
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup _ret_;
    }
    ...
    public GetSetupResult getSetup() {
      ...
      _ret._ret_ = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.Setup.Decode(_result["_ret_"], agent);
      return _ret;
    }
    ...
    public class GetErrorStatusResult {
      public Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus _ret_;
    }
    ...
    public GetErrorStatusResult getErrorStatus() {
      ...
      _ret._ret_ = Com.Raritan.Idl.powerlogic.PowerMeter_1_2_5.ErrorStatus.Decode(_result["_ret_"], agent);
      return _ret;
    }
