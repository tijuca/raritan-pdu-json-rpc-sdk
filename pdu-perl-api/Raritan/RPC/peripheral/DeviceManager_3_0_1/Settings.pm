...
package Raritan::RPC::peripheral::DeviceManager_3_0_1::Settings;
...
sub encode {
    ...
    foreach my $key0 (keys %{$in->{'defaultThresholdsMap'}}) {
        ...
        my $elem0 = {};
        $elem0->{'key'} = "$key0";
        $elem0->{'value'} = Raritan::RPC::sensors::NumericSensor_4_0_2::Thresholds::encode($value0);
...
sub decode {
    ...
    for (my $i0 = 0; $i0 <= $#{$in->{'defaultThresholdsMap'}}; $i0++) {
        ...
        my $value0 = Raritan::RPC::sensors::NumericSensor_4_0_2::Thresholds::decode($agent, $in->{'defaultThresholdsMap'}->[$i0]->{'value'});
